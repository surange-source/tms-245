...
function end(mode, type, selection) {
    if (mode == -1) {
        ...
        if (status == 0) {
            qm.EnableUI(1);
            delay(2000);
            qm.sendDirectionEffectPlay("Effect/DirectionNewPirate.img/effect/tuto/monAttack0");
            delay(2000);
            qm.sendDirectionEffectPlay("Effect/DirectionNewPirate.img/effect/tuto/monAttack1");
            delay(5000);
            ...
            qm.sendDirectionEffectPlay("Effect/DirectionNewPirate.img/newPirate/balloonMsg2/25");
            delay(2000);
            qm.sendDirectionEffectPlay("Effect/DirectionNewPirate.img/newPirate/balloonMsg2/23");
            qm.sendNext("#bThe core#k thuc su o #m240010300#, hay den do...",9270092);
        } else if (status == 9) {
            qm.sendDirectionEffectPlay("Effect/DirectionNewPirate.img/newPirate/balloonMsg2/17");
            delay(3000);
