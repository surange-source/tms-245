...
function start(mode, type, selection) {
    ...
    if (status == -1) {
        ...
        qm.sendYesNo("我是尼子公會的家臣，曾一起參加過本能寺攻略戰，我叫山中幸盛，在介紹詳細情況之前可以先知道一下怎麼稱呼您嗎？");
    } else if (status == 1) {
        if (!qm.isQuestActive(57103)) {
            qm.forceStartQuest();
        }
        qm.sendNextS("我是松山公會的家臣，也是信包的兒子，我叫劍鬥。", 2);
    } else if (status == 2) {
        qm.sendNextPrev("劍斗… 有聽說過好幾次，曉月類的神聖而名揚四海的劍鬥，很榮幸見到你。");
    } else if (status == 3) {
