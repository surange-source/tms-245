...
var itemList = Array(
// ------ 卷軸 ------
Array(2046074, 500, 1, 3), //祥龍單手武器攻擊卷99% 
Array(2046075, 500, 1, 3), //祥龍單手武器魔力卷99% 
Array(2046149, 500, 1, 3)  //祥龍雙手武器攻擊卷99%
);
...
function action(mode, type, selection) {
    ...
    if (status == 0) {
        ...
        if (finalitem.length != 0) {
            ...
            item = im.gainGachaponItem(itemId, quantity, "祥龍99%卷軸箱", notice);
            if (item != -1) {
