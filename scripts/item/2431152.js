...
itemList = Array(
// ------ 坐騎 ------
/*Array(2430406, 500, 1, 3), //飛船7天使用券 [飛船]。 
Array(2430407, 500, 1, 3), //天馬7天使用券 [天馬]。 
Array(2430408, 500, 1, 3), //暗光龍7天使用券 [暗光龍]。 
Array(2430409, 500, 1, 3), //魔法掃帚7天使用券 [魔法掃帚]。 
Array(2430410, 500, 1, 3), //觔斗雲7天使用券 [觔斗雲]。 
Array(2430411, 500, 1, 3), //騎士團戰車7天使用券 [騎士團戰車]。 
Array(2430412, 500, 1, 3), //夢魘7天使用券 [夢魘]。 
Array(2430413, 500, 1, 3), //巴洛古7天使用券 [巴洛古]。
Array(2430440, 500, 1, 3), //透明巴洛古7天使用券 [透明巴洛古]。
Array(2430414, 500, 1, 3), //貓頭鷹7天使用券 [貓頭鷹]。 
Array(2430415, 500, 1, 3), //直升機7天使用券 [直升機]。 
Array(2430416, 500, 1, 3), //妮娜的魔法7天使用券 [妮娜的魔法陣]。
Array(2430417, 500, 1, 3), //青蛙7天使用券 [青蛙]。
Array(2430418, 500, 1, 3), //小龜龜7天使用券 [小龜龜]。
...
Array(2430423, 500, 1, 3), //暴風摩托7天使用券 [暴風摩托]。
Array(2430424, 500, 1, 3), //玩具木馬7天使用券 [玩具木馬]。
...
Array(2430429, 500, 1, 3), //拿破侖的白馬7天使用券 [拿破侖的白馬]。
Array(2430430, 500, 1, 3), //鱷魚王7天使用券 [鱷魚王]。
Array(2430431, 500, 1, 3), //女女機車7天使用券 [女女機車]。
Array(2430432, 500, 1, 3), //男男機車7天使用券 [男男機車]。
Array(2430433, 500, 1, 3), //賽車7天使用券 [賽車]。
Array(2430434, 500, 1, 3), //超能套裝7天使用券 [超能套裝]。
...
Array(3010026, 500, 1, 3), //惡靈附身的娃娃椅子
...
Array(1202023, 100, 1, 3), //真·喬圖騰
Array(1202027, 100, 1, 3), //真·海麗蜜圖騰
Array(1202031, 100, 1, 3), //真·小龍圖騰
Array(1202035, 100, 1, 3), //真·李卡司圖騰
Array(2049122, 500, 1, 3) //正向混沌卷
);
} else if(random == 7){
itemList = Array(
