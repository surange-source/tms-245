...
function action(mode, type, selection) {
    ...
    if (status == 0) {
        var selStr = "#e#r\r\n\r\n";
        selStr += "#b#r#e"+wn1+" 本服樂豆點可以使用楓幣在市場雪人NPC換樂豆點！#k\r\n\r\n\r #b贈送樂豆點10W，餘額50元！\n\r\n\r\n";
        selStr += "#L0##d"+yun+" 領取新開服大禮包#l";  
        selStr += "\r\n\r\n";
       ...
       im.addHyPay(-sl * 1);
       im.gainNX(100000);
       im.gainItem(2431648,-1);
                im.sendOk("恭喜您獲得 樂豆點10W，餘額50元！");
       im.worldSpouseMessage(0x1F, "『新服禮包』" + " : " + "玩家 " + im.getChar().getName() + " 已經領取領取新開服大禮包！");
                im.dispose();
            break;
        case 2:
