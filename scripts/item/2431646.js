...
function action(mode, type, selection) {
    ...
    if (status == 0) {
        var selStr = "#e#r\r\n\r\n";
        selStr += "#b#r#e"+wn1+" 玩家額外補償！（#v2432069# #v2431509# #v2431046#）#b\n\r\n\r\n";
        selStr += "#L0##d"+yun+" 領取獎勵#l";  
        selStr += "\r\n\r\n";
        im.sendSimple(selStr);
    } else if (status == 1) {
        switch (selection) {
        case 0:
         //  if (im.getPQLog("回檔1") < 1) { //工資
       // im.gainItem(4001839,1000); //星星
       im.gainItem(2432069,1);
       im.gainItem(2431509,1);
       im.gainItem(2431046,1);
       im.gainItem(2431646,-1);
                im.sendOk("恭喜您獲得#v2432069# #v2431509# #v2431046#！");
    //  im.worldSpouseMessage(0x20, "『獲得獎勵』" + " : " + "玩家 " + im.getChar().getName() + " 獲得了額外獎勵！");
                im.dispose();
            break;
        case 2:
