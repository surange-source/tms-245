...
function action(mode, type, selection) {
    ...
    if (status == 0) {
        var selStr = "#e#r";
        selStr += "#b#r#e"+wn1+" 新開服V.130，各種活動副本，歡迎你加入！#k\r\n\r\n#b官網：#rwww.223mh.com  #bQQ群２：#r458569952  \r\n\r\n#r免費美容美發，職業技能修復比較好！\r\n\r\n#d→ 領取此禮包進群聯繫棉花客服（發賬號名字即可）！\r\n\r #v4001839# x#r500#k #v2431724# x#r1#k #v2049116# x#r10#k #v5062024# x#r10#k #b以及100000樂豆點，餘額50元！\n\r\n\r\n";
        selStr += "#L0##d"+yun+" 領取棉花禮包#l";  
        selStr += "\r\n\r\n";
       ...
       im.gainItem(4001839,500); //星星
       im.gainItem(2431724,1); //最新椅子
       im.gainItem(2049116,10); //無損強化卷軸
       im.gainItem(5062024,10); //六角方塊
       im.gainItem(4001715,1);
       im.addHyPay(-sl * 1);
       im.gainNX(100000);
       im.gainItem(2431647,-1);
                im.sendOk("恭喜您獲得 #v4001839# x#r500#k #v2431724# x#r1#k #v2049116# x#r10#k #v5062024# x#r10#k #b以及樂豆點10W，餘額50元！");
       im.worldSpouseMessage(0x1A, "『新人禮包』" + " : " + "玩家 " + im.getChar().getName() + " 已經領取了新人大禮包！");
                im.dispose();
            break;
        case 2:
