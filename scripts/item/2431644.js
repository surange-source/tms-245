...
function action(mode, type, selection) {
    ...
    if (status == 0) {
        var selStr = "#e#r\r\n\r\n";
        selStr += "#b#r#e"+wn1+" 請保證背包有1空格在領取，以免造成損失！#b\r\n\r\n #v1113084# x1 ";
        selStr += "\r\n#L0##d"+yun+" 領取#l";  
        selStr += "\r\n\r\n";
       ...
       im.gainItem(1113084,1); 
       im.gainItem(2431643,-1);
                im.sendOk("恭喜您獲得#v1113084# x1 ");
   //    im.worldSpouseMessage(0x1A, "『回檔補償』" + " : " + "玩家 " + im.getChar().getName() + " 已經領取回檔補償大禮包！");
                im.dispose();
            break;
        case 2:
