    ...
    if (cm.getMapId() == 180000001) {
        ...
        for (var i = 0; i < menuList.length; i++) {
            if (menuList[i][3]) { // 如果允許顯示
                ...
                //指定選項更改顏色
                if(menuList[i][2] >= 24 && menuList[i][2] <= 97){
                    selStr += "#b#L" + menuList[i][2] + "#" + menuList[i][0] + " #r" + (menuList[i][2] == 22 && cm.isQuestFinished(1465) ? "一鍵轉職" : menuList[i][1]) + "#l";
                }else{
                    selStr += "#b#L" + menuList[i][2] + "#" + menuList[i][0] + " " + (menuList[i][2] == 22 && cm.isQuestFinished(1465) ? "一鍵轉職" : menuList[i][1]) + "#l";
                }
        ...
        selStr += "\r\n"  +z+z+z+z+z+z+z+"\r\n";
        selStr += "#L1000#  " + ts + "#fs13##e#r進入商城#l\t#L1001# " + ts + "元寶儲值#l";
