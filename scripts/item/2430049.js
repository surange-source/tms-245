function start() {
    if (im.haveItem(2430049)) {
       ...
       im.sendOk("恭喜獲得#r#e#v1672005# #v2431046# #v2431867# #v1662027# #v2431642# #v2430045# #v5062024# x50 #v5062009# x100 #v2049116# x200 #v4001839# x2000!");
       im.worldSpouseMessage(0x0C, "『補償獎勵』" + " : " + "玩家 " + im.getChar().getName() + " 已經領取補償！");
       im.dispose();
} else {
     im.sendOk("沒有了榮譽勳章");
    }
