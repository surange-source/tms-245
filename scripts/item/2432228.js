...
var itemList = Array(
// ------ 卷軸 ------
Array(1112144, 500, 1, 3), //祥龍單手武器攻擊卷99% 
Array(1112101, 500, 1, 3), //祥龍單手武器魔力卷99% 
...
Array(1112148, 500, 1, 3),//祥龍雙手武器攻擊卷99%
...
function action(mode, type, selection) {
    ...
    if (status == 0) {
        ...
        if (finalitem.length != 0) {
            ...
            item = im.gainGachaponItem(itemId, quantity, "卡特琳的禮物", notice);
            if (item != -1) {
