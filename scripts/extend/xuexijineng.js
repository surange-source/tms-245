...
function action(mode, type, selection) {
    ...
    if (status == 0) {
        cm.sendSimple("#fUI/UIWindow2.img/Quest/quest_info/summary_icon/summary#\r\n#fUI/UIWindow2.img/QuestAlarm/BtQ/normal/0#您好 #r#h ##k 有什麼需要我幫忙的嗎？ \r\n#b#b#L2#學習技能#l\r\n#b#b#L1#購買技能冊#l");
    } else if (status == 1) {
        if (selection == 1) {
        cm.dispose();
        cm.openNpc(9270035,"xuexijineng2");
        } else if (selection == 2) {
            status = 5;
            cm.sendSimple("#fUI/UIWindow2.img/Quest/quest_info/summary_icon/summary#\r\n#fUI/UIWindow2.img/QuestAlarm/BtQ/normal/0#您好 #r#h ##k 請選擇您要操作的項目:\r\n#b#L1#群寵技能#l\r\n#L4#騎寵技能#l\r\n#L5#夜光技能#k\r\n#L6#影武1轉技能#k");
        } else if (selection == 3) {
            ...
            if (cm.getPlayer().getCSPoints(1) < 3000) {
                cm.sendOk("您的樂豆點少於 3000 樂豆點，兌換金楓葉失敗！");
            } else if (!cm.canHold(4001168, 1)) {
                cm.sendOk("請檢查您的背包是否有足夠的空間.");
            } else {
                cm.gainItem(4001168, 1); //金楓葉
                cm.gainNX( - 3000);
                cm.sendOk("兌換成功！獲得金楓葉1個，此道具價值 3000 樂豆點。如果將道具兌換成楓幣我們將收取200樂豆點的手續費。");
            }
            cm.dispose();
