...
function action(mode, type, selection) {
    if (mode == -1) {
        ...
        if (mode == 1)
            ...
            status--;
        if (status == 0) { 
            cm.sendSimple("#fUI/UIWindow2.img/QuestGuide/Button/WorldMapQuestToggle/normal/0#\r\n#L3##fUI/UIWindow2.img/QuestAlarm/BtQ/normal/0#[運氣]豪情賭拿中介    (#k目前狀態： #r火爆推薦#b)#l\r\n\r\n#L6##fUI/UIWindow2.img/QuestAlarm/BtQ/normal/0#[裝備]免費一鍵潛能    (#k目前狀態： #r火爆推薦#b)#l\r\n\r\n#L4##fUI/UIWindow2.img/QuestAlarm/BtQ/normal/0#[武器]傷害上限突破    (#k需要： #v4033356#  #v3991014#)#l\r\n\r\n  ");
        } else if (status == 1) {
            if (selection == 1) {
