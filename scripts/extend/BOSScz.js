...
var List = Array(
                ...
                Array("強化鑽機",11000,0,1,0,0),
                Array("皮埃爾",15000,0,1,0,0),
                Array("進階皮埃爾",70000,0,1,0,100000),
                Array("腥血女王",15000,0,1,0,0),
                Array("進階腥血女王",70000,0,1,0,100000),
                Array("貝倫",15000,0,1,0,0),
                Array("進階貝倫",70000,0,1,0,100000),
                Array("半半",15000,0,1,0,0),
                Array("進階半半",70000,0,1,0,100000),
                Array("皮卡啾",10000,0,2,0,0),
                Array("混沌皮卡啾",20000,0,1,0,0),
                Array("拉圖斯",0,0,1,0,3000),
                Array("妖精女王",9000,0,1,0,2000),
                Array("黃金寺院",9000,0,1,0,1000),
                Array("阿卡伊農[普通]",10000,0,1,0,0),
                Array("女皇：西格諾斯",19000,0,1,0,5000),
                Array("森蘭丸",18000,0,1,0,0),
                Array("桃樂絲",30000,0,1,20,0),
                                Array("濃姬",50000, 0, 1, 0, 0),
