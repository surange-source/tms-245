...
var 購買的屬性裝備 = 1114201; 
var 需要樂豆點 = 000000;
var 需要道具ID_4 = 1114219;  var 需要數量_4 = 1;
var 需要道具ID_3 = 4000000;  var 需要數量_3 = 3000;
var 需要道具ID_2 = 4000016;  var 需要數量_2 = 3000;
...
function action(mode, type, selection) {
    if (mode == -1) {
        ...
        if (status == 0) {
            ...
            txt += "#b  初見瑪瑙戒指 [ 30 ] 分別 - 全屬性裝備 #r#z"+購買的屬性裝備+"# #k\r\n"
            txt += "#d       當前擁有#i" + 需要道具ID_4 + "#數量 :#r" + cm.getItemQuantity(需要道具ID_4) + "#d#k#b需要1個\r\n\r\n";
            txt += "#d      當前擁有#i" + 需要道具ID_3 + "#數量 :#r" + cm.getItemQuantity(需要道具ID_3) + "#d#k#b需要3000個\r\n\r\n";
            ...
            if (cm.getItemQuantity(需要道具ID_3) >= 需要數量_3&&cm.getItemQuantity(需要道具ID_4) >= 需要數量_4&&cm.getItemQuantity(需要道具ID_2) >= 需要數量_2) {
                    ...
                    var toDrop = cm.getNewEquip(1114201); // 生成一個Equip類 耳環
                ...
                cm.gainItem(需要道具ID_3, -需要數量_3);
                    ...
                    cm.worldSpouseMessage(0x26, "[系統提示] : 玩家 "+cm.getPlayer().getName()+"經過爆肝般的努力,終於將瑪瑙戒指提升至  『2』階");
