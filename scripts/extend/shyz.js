...
var status = 0;
var choice;
var itemxh=new Array("3014000","3014001","3014002","3014003","3014004","3014006","3014008","3014009","3014010");
var itemxhcost=new Array("200000","200000","200000","200000","200000","200000","200000","200000","200000");
    ...
    if (mode == -1) cm.dispose();
        ...
        choice = selection;
            ...
            cm.gainItem(itemxh[choice], fee);
                cm.worldSpouseMessage(0x0D,"[說話椅子] :  "+ cm.getChar().getName() +"  在樂豆點商店購買了會說話的椅子!");
            cm.sendOk("恭喜，購買成功。");
            cm.dispose();
             }
        }
