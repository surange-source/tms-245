...
var giftContent = Array(
  ...
  Array("100%力量瑪瑙石 X 1--只能用於成長型瑪瑙戒指", 5, Array(
        Array(2643002, 1)
    )),
  Array("100%敏捷瑪瑙石 X 1--只能用於成長型瑪瑙戒指", 5, Array(
        Array(2643003, 1)
    )),
  Array("100%智力瑪瑙石 X 1--只能用於成長型瑪瑙戒指", 5, Array(
        Array(2643004, 1)
    )),
  Array("100%運氣瑪瑙石 X 1--只能用於成長型瑪瑙戒指", 5, Array(
        Array(2643005, 1)
    )),
  Array("100%體力瑪瑙石 X 1--只能用於成長型瑪瑙戒指", 5, Array(
        Array(2643006, 1)
    )),
  Array("100%均衡瑪瑙石 X 1--只能用於成長型瑪瑙戒指", 5, Array(
        Array(2643007, 1)
    )),
  Array("100%破壞瑪瑙石 X 1--只能用於成長型瑪瑙戒指", 5, Array(
        Array(2643106, 1)
    )),
  Array("100%魔力瑪瑙石 X 1--只能用於成長型瑪瑙戒指", 5, Array(
        Array(2643107, 1)
    )),
  Array("100%強大的力量瑪瑙石 X 1--只能用於完成型瑪瑙戒指", 10, Array(
        Array(2643116, 1)
    )),
  Array("100%強大的敏捷瑪瑙石 X 1--只能用於完成型瑪瑙戒指", 10, Array(
        Array(2643117, 1)
    )),
  Array("100%強大的智力瑪瑙石 X 1--只能用於完成型瑪瑙戒指", 10, Array(
        Array(2643118, 1)
    )),
  Array("100%強大的運氣瑪瑙石 X 1--只能用於完成型瑪瑙戒指", 10, Array(
        Array(2643119, 1)
    )),
  Array("100%強大的體力瑪瑙石 X 1--只能用於完成型瑪瑙戒指", 10, Array(
        Array(2643120, 1)
    )),
  Array("100%強大的均衡瑪瑙石 X 1--只能用於完成型瑪瑙戒指", 10, Array(
        Array(2643121, 1)
    ))
);
var giftId = -1;
