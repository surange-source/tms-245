...
var 購買的屬性裝備 = 1114225; 
var 需要樂豆點 = 000000;
var 需要道具ID_3 = 4032006;  var 需要數量_3 = 1200;
var 需要道具ID_4 = 1114221;  var 需要數量_4 = 1;
var 需要道具ID_2 = 4000115;  var 需要數量_2 = 5000;
var 需要道具ID_1 = 4000134;  var 需要數量_1 = 5000;
...
function action(mode, type, selection) {
    if (mode == -1) {
        ...
        if (status == 0) {
            ...
            txt += "#b  初見瑪瑙戒指 [ 110 ] 分別 - 全屬性裝備 #r#z"+購買的屬性裝備+"# #k\r\n"
            txt += "#d       當前擁有#i" + 需要道具ID_4 + "#數量 :#r" + cm.getItemQuantity(需要道具ID_4) + "#d#k#b需要1個\r\n\r\n";
            txt += "#d      當前擁有#i" + 需要道具ID_3 + "#數量 :#r" + cm.getItemQuantity(需要道具ID_3) + "#d#k#b需要1200個\r\n\r\n";
            txt += "#d      當前擁有#i" + 需要道具ID_2 + "#數量 :#r" + cm.getItemQuantity(需要道具ID_2) + "#d#k#b需要5000個\r\n\r\n";
            txt += "#d      當前擁有#i" + 需要道具ID_1 + "#數量 :#r" + cm.getItemQuantity(需要道具ID_1) + "#d#k#b需要5000個\r\n\r\n";
            txt += "　　　　　　　　　　　　 #i"+購買的屬性裝備+"# 　　　　　　　　　　\r\n\r\n";
            ...
            if (cm.getItemQuantity(需要道具ID_3) >= 需要數量_3&&cm.getItemQuantity(需要道具ID_4) >= 需要數量_4&&cm.getItemQuantity(需要道具ID_2) >= 需要數量_2&&cm.getItemQuantity(需要道具ID_1) >= 需要數量_1) {
               
                    var ii = cm.getItemInfo();
                    var toDrop = cm.getNewEquip(1114225); // 生成一個Equip類 耳環
                ...
                cm.gainItem(需要道具ID_1, -需要數量_1);                
                    ...
                    cm.worldSpouseMessage(0x26, "[系統提示] : 玩家 "+cm.getPlayer().getName()+"經過爆肝般的努力,終於將瑪瑙戒指提升至  『4』階");
