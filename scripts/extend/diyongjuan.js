...
var itemList = Array(
    //道具代碼，楓點，數量， 次數：-1為不限制
        Array(4009453, 1200, 1, 100),
    Array(5062000, 6000, 1, 30),
    Array(5050000, 50000, 100, -1),
    Array(5062002, 20000, 1, 10),
    Array(5062500, 40000, 1, 10),
    Array(5062010, 90000, 5, 10),
    Array(5062009, 100000, 5, 10),
    Array(2340000, 9000, 1, 20),
    Array(5064000, 30000, 1, 10),
    //Array(2049116, 30000, 1, 10),
    //Array(2049124, 30000, 1, 10),
    Array(2049402, 25000, 1, 10),
    Array(5076000, 8000, 1, -1),
    Array(5072000, 5000, 1, -1)
);
function start() {
    action(1, 0, 0);
}
