...
var status = 0;
var 購買的屬性裝備 = 1143000;  var 全屬性數值 = 500;
var 需要樂豆點 = 000000;
var 需要道具ID_5 = 1142541;  var 需要數量_5 = 1;
var 需要道具ID_4 = 2432022;  var 需要數量_4 = 1;
...
function action(mode, type, selection) {
    if (mode == -1) {
        ...
        if (status == 0) {
            ...
            txt += "#b  最強勳章全屬性 [ 400 ] 分別 - 全屬性裝備 #r#z"+購買的屬性裝備+"# #k\r\n"
            ...
            cm.sendYesNo(txt);
             ...
             if (cm.getItemQuantity(需要道具ID_5) >= 需要數量_5&&cm.getItemQuantity(需要道具ID_4) >= 需要數量_4) {
                    ...
                    var toDrop = cm.getNewEquip(1143000); // 生成一個Equip類 耳環
                    ...
                    toDrop.setBossDamage(35);//Boss 攻擊百分比%
                ...
                cm.gainItem(需要道具ID_5, -需要數量_5);
                    ...
                    cm.worldSpouseMessage(0x26, "[系統提示] : 恭喜玩家 "+cm.getPlayer().getName()+" 成功兌換VIP5至尊勳章,每日福利多多噢！");
