...
var 需要道具ID_4 = 1114209;  var 需要數量_4 = 1;
...
newEquip = cm.getEquipBySlot(1);
    ...
    return;
            ...
            txt += "#b  初見瑪瑙戒指 [ 300 ] 分別 - 全屬性裝備 #r#z"+購買的屬性裝備+"# #k\r\n"
            ...
            if (cm.getItemQuantity(需要道具ID_5) >= 需要數量_5&&cm.getItemQuantity(需要道具ID_4) >= 需要數量_4) {
                    ...
                    var toDrop = cm.getNewEquip(1114211); // 生成一個Equip類 耳環
                    ...
                    toDrop.setMatk(260); //魔法攻擊
                    toDrop.setWatk(260); //攻擊攻擊 
                ...
                cm.gainItem(需要道具ID_5, -需要數量_5);                    
                    cm.playerMessage(1, "　" + cm.getChar().getName() + "\r\n\r\n恭喜你兌換成功!\r\n\r\n感謝你對幸運的支持 祝您遊戲愉快");
                     cm.worldSpouseMessage(0x26, "[系統提示] : 玩家 "+cm.getPlayer().getName()+"通過使用七彩楓葉,終於將瑪瑙戒指提升至  『7』階");
cm.changePotential(1,1, 60004, false);
cm.changePotential(1,4, 60004, false);
cm.changePotential(1,6, 60004, false);
cm.changePotential(1,5, 60004, false);
                    cm.dispose();
