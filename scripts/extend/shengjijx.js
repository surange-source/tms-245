...
function action(mode, type, selection) {
    ...
    if (status == 0) {
            var selStr = "#d把勳章取下放背包，請選擇當前需要晉級的軍銜：#n#k\r\n";
        selStr +="#e#r#L0#"+zs1+"晉級到『團長軍銜』全屬性+25#l#n\r\n\r\n";
        selStr +="#e#r#L1#"+zs1+"晉級到『旅長軍銜』全屬性+50#l#n\r\n\r\n";
        selStr +="#e#r#L2#"+zs1+"晉級到『師長軍銜』全屬性+75#l#n\r\n\r\n";
        selStr +="#e#r#L3#"+zs1+"晉級到『軍長軍銜』全屬性+100#l#n\r\n\r\n";;
        cm.sendSimple(selStr);
    } else if (status == 1) {
        switch (selection) {
        case 0:
            cm.dispose();
            cm.openNpc(1500032,"jx4");
            break;
        case 1:
            cm.dispose();
            cm.openNpc(1500032,"jx5");
            break;
        case 2:
            cm.dispose();
            cm.openNpc(1500032,"jx6");
            break;
        case 3:
            cm.dispose();
            cm.openNpc(1500032,"jx7");
            break;
        }
    }
}
