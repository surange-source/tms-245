...
var day3 = ca.get(java.util.Calendar.DATE);//獲取日
var day = ca.get(java.util.Calendar.DATE);//獲取日
var day1 = ca.get(java.util.Calendar.YEAR);//獲取年
var day2 = ca.get(java.util.Calendar.MONTH)+1;//獲取月
//var day2 = ca.get(java.util.Calendar.HOUR_OF_DAY);//獲取月
...
function action(mode, type, selection) {
    ...
    if (status == 0) {
        var selStr = "\r\n#e#b打開就會扣除樂豆點，需要#r50W#b樂豆點才能滿技能！！！\r\n#n#d#e#L0#" + fff + "打開滿技能NPC#r(50W樂豆點)#l";
        ...
        case 0:
           if (cm.getPlayer().getCSPoints(1) >= 500000) {
            ...
            cm.openNpc(9000154,"mjn");
                    cm.gainNX(1, -500000);
//cm.worldSpouseMessage(0x15,"[土豪]"+ cm.getChar().getName() +"  在市場[工作人員咪咪]打開了任意刷物品NPC，大家快去打劫他(她)！");
            }else{
                cm.sendOk("你沒有足夠的樂豆點無法打開！");
        cm.dispose();
            }
            break;
        case 1:
...
cm.worldSpouseMessage(0x15,"[刷物品-新]"+ cm.getChar().getName() +"  在市場[工作人員咪咪]打開了任意刷物品NPC，大家快去打劫他(她)！");
            }else{
                cm.sendOk("你沒有足夠的 #v4000313# #z4000313# 無法打開！");
        cm.dispose();
            }
            break;
        case 2:
