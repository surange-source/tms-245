...
function action(mode, type, selection) {
    ...
    if (cm.getMapId() == 180000001) {
        ...
        txt += "　#b※ 並且保證兩者數量 [ #r1000#b ] 個 #r所有怪都有爆率#b　※#k#n\r\n　#b※ #r萬能傳送 - 快速練級 - 大蘑菇 （#g藍蝸牛 可爆#b）#b ※\r\n\r\n";
        txt += "　#b※ 當前擁有#z4001231#數量：\t\t\t　#r" + cm.itemQuantity(4001231) + " / 1000 個#b\r\n";
        txt += "　#b※ 當前擁有#z4001395#數量：\t\t#r" + cm.itemQuantity(4001395) + " / 1000 個#b\r\n\r\n";
        txt += "　#d　　　 當前已累計獲得樂豆點數量：#r" + sddj + "#d 樂豆點#k\r\n";
        txt += "#d└═════════════════════════┘#k\r\n\r\n";
        cm.sendYesNoS(txt, 2);
    } else if (status == 1) {
        var txt = "\r\n#d┌═══════════聖誕查詢══════════┐#k\r\n\r\n";
        txt += "　#b※ 請確認玩家聖誕道具是否收集齊全　否側導致失敗　※#k#n\r\n\r\n";
        txt += "　#b※ 如確認請單擊 [ #r是#b ]　　　　否則請單擊 [ #r否#b ]　※#k#n\r\n\r\n";
        txt += "　#b※ 如玩家提供的數量正確　將領到  #r5000#b　 樂豆點　　※#k#n\r\n\r\n";
        txt += "#d└═════════════════════════┘#k\r\n\r\n";
        cm.sendYesNoS(txt, 2);
    } else if (status == 2) {
        if (cm.getEventCount("快樂聖誕") == 1) {
        ...
        if (cm.haveItem(4001231, 1000) && cm.haveItem(4001395, 1000)) {
            ...
            cm.setEventCount("聖誕樂豆點", 1, 5000);
            cm.playerMessage(1, "　" + cm.getChar().getName() + "\r\n\r\n　尊敬的玩家恭喜你\r\n\r\n已完成快樂聖誕 - 領樂豆點 [ 5000 ]");
            cm.worldSpouseMessage(0x01, "※ 快樂聖誕 ※ : 恭喜玩家[ " + cm.getPlayer().getName() + " ]完成 快樂聖誕 並獲得 5000 樂豆點 ●ω●");
                cm.worldSpouseMessage(0x01, "※ 快樂聖誕 ※ : 恭喜玩家[ " + cm.getPlayer().getName() + " ]完成 快樂聖誕 並獲得 5000 樂豆點 ●ω●");
            cm.worldSpouseMessage(0x01, "※ 快樂聖誕 ※ : 恭喜玩家[ " + cm.getPlayer().getName() + " ]完成 快樂聖誕 並獲得 5000 樂豆點 ●ω●");
            cm.dispose();
        } else {
