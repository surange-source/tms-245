...
function action(mode, type, selection) {
    ...
    if (status == 0) {
        var selStr = "\r\n" + bbb + " 你目前擁有：#r" + cm.itemQuantity(4220180) + " #k個 #b<#z4220180#>#k#n\r\n\r\n#e#r注意：一個空格可以裝5000個星星！#n\r\n\r\n#b#L0#" + yun + "100個#v4220180#兌換100個#v4001839#\r\n\r\n#b#L2#" + yun + "500個#v4220180#兌換500個#v4001839#\r\n\r\n#b#L1#" + yun + "1000個#v4220180#兌換1000個#v4001839#\r\n";
 cm.sendSimple(selStr);
        ...
        cm.gainItem(4001839, 100);
                cm.sendOk("兌換成功：獲得#b100個#v4001839#!");
          cm.worldSpouseMessage(0x20, "[星星交換] : 恭喜 " + cm.getChar().getName() + " 在市場相框兌換了100個星星！");
            cm.dispose();
            } else {
                cm.sendOk("#r兌換失敗:\r\n#b1.你沒有足夠的#v4220180#!");
            cm.dispose();
        ...
        cm.gainItem(4001839, 1000);
                cm.sendOk("兌換成功：獲得#b1000個#v4001839#!");
          cm.worldSpouseMessage(0x20, "[星星交換] : 恭喜 " + cm.getChar().getName() + " 在市場相框兌換了1000個星星！");
            cm.dispose();
            } else {
                cm.sendOk("#r兌換失敗:\r\n#b1.你沒有足夠的#v4220180#!")
            cm.dispose();
        ...
        cm.gainItem(4001839, 500);
                cm.sendOk("兌換成功：獲得#b500個#v4001839#!");
          cm.worldSpouseMessage(0x20, "[星星交換] : 恭喜 " + cm.getChar().getName() + " 在市場相框兌換了500個星星！");
            cm.dispose();
            } else {
                cm.sendOk("#r兌換失敗:\r\n#b1.你沒有足夠的#v4220180#!")
            cm.dispose();
