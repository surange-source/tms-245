...
function action(mode, type, selection) {
    ...
    if (status == 0) {
       ...
       cm.gainItem(4310091,-1000); //減少1個使用的這個道具
       cm.sendOk("獲取了 #v"+psrw[rand][0]+"# "+psrw[rand][1]+"個")
    cm.worldSpouseMessage(0x18, "『家園守衛』" + " : " + "[" + cm.getChar().getName() + "]獲得了" + psrw[rand][1] + "個<" + ii.getName(psrw[rand][0]) + ">,快去挑戰吧");
       cm.dispose(); 
    }
        }
        }
