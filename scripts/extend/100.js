...
var maxPartySize = 6;
var XZ;
var name0 = "[系列]神木村組隊任務";
var name = Array(
        Array("[執行]神木村-紅飛龍峽谷","紅飛龍峽谷","NewEvent3",1000,230),//執行顯示的名字、事件記錄、事件腳本名稱、帳號次數、怪物等級
        Array("[執行]神木村-米納爾森林西部","米納爾森林西部","NewEvent1",100,200),
        Array("[執行]神木村-米納爾森林東部","米納爾森林東部","NewEvent34",100,210),
        Array("[執行]神木村-黃昏之林","黃昏之林","NewEvent2",100,240)
);
