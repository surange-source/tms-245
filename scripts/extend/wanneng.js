...
function action(mode, type, selection) {
    ...
    if (cm.getMapId() == 180000001) {
        ...
        var selStr = "";
           selStr += "#L0#" + eff + "#b  百寶抽獎#l\n\n\n";
        //selStr += "#L1#" + eff + "  遊戲排名#l\n\n\n";    
        selStr += "#L2#" + eff + "  道具刪除#k#l\r\n\r\n";    
        selStr += "#L3#" + eff + "#r  答題活動#l\n\n\n";
        selStr += "#L4#" + eff + "  結婚地圖#l\n\n\n";
        //selStr += "#L5#" + eff + "  道具刪除#l\r\n\r\n";
        //selStr += "#L6#" + eff + "  裝備分解#k#l\n\n\n";
        //selStr += "#L7#" + eff + "#r  競技積分#k#l\n\n\n";
        selStr += "#L8#" + eff + "#r  楓點商城#k#l\n\n\n\r\n";
        selStr += "#L9#" + eff + "#r  數字猜猜#k#l\n\n\n";
        //selStr += "#L10#" + eff + "#r  數字猜猜#k#l\n\n\n";
        cm.sendSimple(selStr);
    } else if (status == 1) {
        switch (selection) {
        case 10:
            cm.dispose();
            cm.openNpc(9900004,"hzbloo");
            break;
        case 0:
            cm.dispose();
            cm.warp(749050400);
