        ...
        if (status == 0) {
            ...
            if (selection == 0) {
                ...
                if (pet == null || !cm.haveItem(5380000, 1)) {
                    cm.sendOk("你不符合要求。你需要 #i5380000##t5380000#, 以及任何一個 #d#i5000029##t5000029##k, #g#i5000030##t5000030##k, #r#i5000035##t5000035##k, #b#i5000032##t5000032##k, or #e#i5000033##t5000033##n 設置在15級或更高。請回來的時候你做的.");
                    cm.dispose();
                } else {
                    ...
                    cm.sendOk("你的龍已經演變! 它曾經是一個#i" + id + "##t" + id + "#, a現在它是一個 #i" + after + "##t" + after + "#!");
                    cm.dispose();
                }
            } else if (selection == 1) {
                var currentpet = null;
                ...
                if (pet == null || !cm.haveItem(5380000, 1)) {
                    cm.sendOk("你不符合要求。你需要 #i5380000##t5380000#, 以及任何一個 #g#i5000048##t5000048##k, #r#i5000049##t5000049##k, #b#i5000050##t5000050##k, #d#i5000051##t5000051##k, #d#i5000052##t5000052##k, or #e#i5000053##t5000053##n 設置在15級或更高。請回來當你這樣做的.");
                    cm.dispose();
                } else {
                    var id = pet.getPetItemId();
                    var name = pet.getName();
                    ...
                    cm.gainPet(after, name, level, closeness, fullness, 45, flag);
                    cm.getPlayer().spawnPet(slot);
                    cm.sendOk("你的機器人已經演變！它使用的是一個！ #i" + id + "##t" + id + "#, 現在它是一個 #i" + after + "##t" + after + "#!");
                    cm.dispose();
                }                
              } else if (selection == 3) {
                var currentpet = null;
                for (var i = 0; i < 3; i++) {
                    currentpet = cm.getPlayer().getSpawnPet(i);
                    if (currentpet != null && pet == null) {
                        if (currentpet.getSummoned() && currentpet.getPetItemId() >= 5000047 && currentpet.getPetItemId() <= 5000054 && currentpet.getLevel() >= 25) {
                            pet = currentpet;
                            break;
                        }
                    }
                }
                if (pet == null || !cm.haveItem(5380000, 1) || !cm.haveItem(4000000, 200)) {
cm.sendOk("你不符合要求。#b你需要1個#i5380000##t5380000#，以及1個25級的#i5000048##t5000048#和200個藍蝸牛#v4000000##k\r\nP:進化之石和#i5000047#和升級機器人的輕油可在商城購買\r\n                  #r將隨機獲得以下寵物\r\n#r———————————————————————————\r\n#r#i5000137##k,#r#i5000103##k,#r#i5000038##k#r#i5000128##k,#r#i5000096##k,#r#i5000026##k,#r#i5000093##k,#r#i5000092##k,#r#i5000091##k,#r#i5000027##k,#r#i5000081##k,#r#i5000072##k,#r#i5000038##k,#r#i5000054##k,#r#i5000203##k,#r#i5000204##k,#r#i5000205##k,#r#i5000208##k,#r#i5000209##k,#r#i5000212##k,#r#i5000213##k,#r#i5000214##k,#r#i5000206##k,#r#i5000215##k,#r#i5000216##k,#r#i5000217##k,#r#i5000221##k,#r#i5000225##k,#r#i5000228##k,#r#i5000229##k,#r#i5000230##k,#r#i5000237##k,#r#i5000243##k,#r#i5000244##k,#r#i5000245##k,#r#i5000284##k,#r#i5000247##k,#r#i5000285##k,#r#i5000252##k,#r#i5000253##k,#r#i5000324##i5000433##i5000434##i5000435##i5000414##i5000424##i5000409##i5000408##i5000407##i5000406##i5000405##i5000402##i5000390##i5000389##i5000388##i5000391##i5001011##i5001010##i5001009##i5000308##i5000307##i5000306##i5000255##i5000382##i5000191##i5000261##i5000251##i5000250##i5000249##i5000258##i5000257##i5000256##i5000365##i5000366##i5000367##i5000287##i5000288##i5000289##i5000369##i5000370##i5000371##i5000331##i5000330##i5000332##i5000055##i5000416##i5000417##i5000415##k,");
                    cm.dispose();
                } else {
                    var id = pet.getPetItemId();
                    var name = pet.getName();
                    ...
                    var after = id;
                    while (after == id) {
                        rand = 1 + Math.floor(Math.random() * 171);
                        if (rand >= 1 && rand <= 2) {
                            after = 5000096;
                        } else if (rand >= 3 && rand <= 4) {
                            after = 5000026;
                    ...
                    cm.gainPet(after, name, level, closeness, fullness, 45, flag);
                    cm.getPlayer().spawnPet(slot);
                    cm.sendOk("你的寵物已經演變！它使用的是一個！ #i" + id + "##t" + id + "#, 現在它是一個 #i" + after + "##t" + after + "#!");
                    cm.worldSpouseMessage(0x20, "『寵物進化』" + " : " + "玩家 " + cm.getChar().getName() + " 在愛慕寵物店進行了神寵隨機!");
                    cm.dispose();
                }
                ...
                if (theitems.length <= 0) {
                    ...
                    var selStr = "請選擇寵物復活。你需要生活的水使它復活.#b\r\n";
