...
function action(mode, type, selection) {
    if (mode == -1) {
        ...
        if (status == 0) {
            cm.sendSimple("你現在選擇的是 #r美容美發#k 還能什麼開始打造自己吧!\r\n已經更新#rver130#k所有臉型和髮型,普通沒有的,都在皇家裡面\r\n" + bbb + " 賬號目前 (#k贊助金額： #r"+cm.getHyPay(1)+"元#k)\r\n" + bbb + " 你有: #r" + cm.itemQuantity(5150040) + " #k張#b<#z5150040#>#k" + bbb + " 你有: #r" + cm.itemQuantity(5152053) + " #k張#b<#z5152053#>#k\r\n#L4#" + aaa + " #b皮膚染色#l\r\n#L2#" + aaa + " 髮型染色#l\r\n#L0#" + aaa + " 改變臉型#l\r\n#L1#" + aaa + " 眼睛染色#l\r\n#L3#" + aaa + " 普通髮型一#l\r\n#L5#" + aaa + " 普通髮型二#l\r\n#L8#" + aaa + " #d皇家130髮型#e#n#l\r\n#L18#" + aaa + " 機器人整容#k#l"); //#L18#" + aaa + " 機器人整容#k#l  #L8#" + aaa + " #r貴族130最新髮型#l\r\n    #L0#" + aaa + " 改變臉型#l\r\n
        } else if (status == 1) {
            if (selection == 0) {
                facenew = Array();
                ...
                cm.sendStyle("我可以改變你的臉型,讓它比現在看起來漂亮. 你為什麼不試著改變它下? ,我將會幫你改變你的臉型,那麼選擇一個你想要的新臉型吧!", facenew, 5152057,false);
            } else if (selection == 1) {
                beauty = 1;
                if (cm.getChar().getGender() == 0) {
                ...
                cm.sendStyle("請選擇你喜歡的顏色.", colors, 5151036,false);
            } else if (selection == 2) {
                beauty = 2;
                haircolor = Array();
                ...
                cm.sendStyle("我可以改變你的髮色,讓它比現在看起來漂亮. 你為什麼不試著改變它下? 我將會幫你改變你的髮色,那麼選擇一個你想要的新髮色吧!", haircolor, 5151036,false);
                ...
                cm.sendStyle("我可以改變你的髮型,讓它比現在看起來漂亮.你為什麼不試著改變它下? 我將會幫你改變你的髮型,那麼選擇一個你想要的新髮型吧!", hairnew, 5150040,false);
            } else if (selection == 4) {
                beauty = 4;
                cm.sendStyle("用我們特殊開發的機器可查看護膚後的效果噢,想換成什麼樣的皮膚呢？請選擇～~", skin, 5153000,false);
            } else if (selection == 6) {
                    cm.dispose();
                    cm.openNpc(1012117);
            } else if (selection == 7) {
            ...
            cm.dispose();
            if (beauty == 0) {
                if (cm.haveItem(5152057) == 0) {
                    cm.gainItem(5152057, -0);
                    ...
                    cm.sendOk("看起來你並沒有我們的高級會員卡,我恐怕不能給你進行整形手術,我很抱歉.請你先購買吧.");
                }
            } else if (beauty == 1) {
                if (cm.haveItem(5151036) == 0) {
                    cm.gainItem(5151036, -0);
                ...
                if (cm.haveItem(2430865) == 0) {
                    cm.gainItem(2430865, -0);
