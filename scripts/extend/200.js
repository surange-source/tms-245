...
var maxPartySize = 6;
var XZ;
var name0 = "[系列]納希沙漠組隊任務";
var name = Array(
        Array("[執行]納希沙漠-納希沙漠西門外","納希沙漠西門外","NewEvent5",100,100),//執行顯示的名字、事件記錄、事件腳本名稱、帳號次數、怪物等級
        Array("[執行]納希沙漠-納希沙漠東門外","納希沙漠東門外","NewEvent6",100,120),
        Array("[執行]納希沙漠-納希沙漠北門外","納希沙漠北門外","NewEvent7",100,150),
        Array("[執行]納希沙漠-金字塔","金字塔","NewEvent8",100,180)
);
