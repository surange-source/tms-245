...
newEquip = cm.getEquipBySlot(1);
    ...
    return;
            ...
            if (cm.getItemQuantity(需要道具ID_4) >= 需要數量_4) {
                    ...
                    var toDrop = cm.getNewEquip(1662093); // 生成一個Equip類 耳環
                    ...
                    cm.changePotential(1,1, 40051, false);
                    cm.changePotential(1,2, 40051, false);
                    cm.changePotential(1,3, 40051, false);
                    cm.dispose();
