...
var 購買的屬性裝備 = 1114231; 
var 需要樂豆點 = 000000;
var 需要道具ID_5 = 2431319; 
var 需要數量_5 = 3;
var 需要道具ID_4 = 1114230;
var 需要數量_4 = 1;
...
newEquip = cm.getEquipBySlot(1);
    ...
    return;
            ...
            txt += "#b  初見瑪瑙戒指 [ 800 ] 分別 - 全屬性裝備 #r#z"+購買的屬性裝備+"# #k\r\n"
            txt += "#d       當前擁有#i" + 需要道具ID_4 + "#數量 :#r" + cm.getItemQuantity(需要道具ID_4) + "#d#k#b需要1個\r\n\r\n";
            txt += "#d      當前擁有#i" + 需要道具ID_5 + "#數量 :#r" + cm.getItemQuantity(需要道具ID_5) + "#d#k#b需要3個\r\n\r\n";
            txt += "　　　　　　　　　　　　 #i"+購買的屬性裝備+"# 　　　　　　　　　　\r\n\r\n";
            ...
            if (cm.getItemQuantity(需要道具ID_5) >= 需要數量_5&&cm.getItemQuantity(需要道具ID_4) >= 需要數量_4) {
                    ...
                    var toDrop = cm.getNewEquip(1114231); // 生成一個Equip類 耳環
                    toDrop.setStr(900); //裝備力量
                    toDrop.setDex(900); //裝備敏捷
                    toDrop.setInt(900); //裝備智力
                    toDrop.setLuk(900); //裝備運氣
                    toDrop.setHp(9000);
                    toDrop.setAcc(100); //命中率
                    toDrop.setMatk(620); //魔法攻擊
                    toDrop.setWatk(620); //攻擊攻擊 
                ...
                cm.gainItem(需要道具ID_5, -需要數量_5);                    
                    ...
                    cm.worldSpouseMessage(0x26, "[系統提示] : 玩家 "+cm.getPlayer().getName()+"通過使用專屬色子,終於將瑪瑙戒指封印解除了,提升至滿階  『12』階!!! 全世界都將為你顫抖!!!");
                    cm.worldSpouseMessage(0x26, "[系統提示] : 玩家 "+cm.getPlayer().getName()+"通過使用專屬色子,終於將瑪瑙戒指封印解除了,提升至滿階  『12』階!!! 全世界都將為你顫抖!!!");
                    cm.worldSpouseMessage(0x26, "[系統提示] : 玩家 "+cm.getPlayer().getName()+"通過使用專屬色子,終於將瑪瑙戒指封印解除了,提升至滿階  『12』階!!! 全世界都將為你顫抖!!!");
                    cm.worldSpouseMessage(0x26, "[系統提示] : 玩家 "+cm.getPlayer().getName()+"通過使用專屬色子,終於將瑪瑙戒指封印解除了,提升至滿階  『12』階!!! 全世界都將為你顫抖!!!");
