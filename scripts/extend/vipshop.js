...
var giftContent = Array(
 Array("勳章神秘鐵砧",   250, Array(
        Array(5062402, 1)
    )),
 Array("神秘力量勳章(含三枚)",   300, Array(
        Array(2430026, 1)
    )),
 Array("神秘力量升級材料(1)",   40, Array(
        Array(1712000, 1)
    )),
 ...
 //Array("完美飾品防具卷軸 X 10", 400, Array(
       // Array(2616051, 10)
    //)),
 Array("專屬紫金楓葉羽毛 X 1", 1000, Array(
        Array(2570002, 1)
    )),

 Array("17星星之力強化卷",   100, Array(
        Array(2049371, 1)
    )),
 Array("18星星之力強化卷",   200, Array(
        Array(2049387, 1)
    )),
 Array("19星星之力強化卷",   400, Array(
        Array(2049388, 1)
    )),
 Array("20星星之力強化卷",   600, Array(
        Array(2049389, 1)
    )),
  Array("瑪瑙戒指禮包1",   100, Array(
        Array(2433444, 1)
    )),
  Array("瑪瑙戒指禮包2",   150, Array(
        Array(2435087, 1)
    )),
  Array("瑪瑙戒指禮包3",   300, Array(
        Array(2434174, 1)
    )),
  Array("彩色楓葉",   600, Array(
        Array(4032733, 1)
    )),
 ...
 Array("遺忘之神話耳環",   300, Array(
  ...
  Array("法弗納防具箱（自選)",   500, Array(
   ...
   //     Array(1182158, 1)
    ...
    Array("黑龍傳說指環(每個角色限購一次)",   350, Array(
        Array(1113084, 1)
    )), 
    Array("獨眼巨人之眼Lv.3",   100, Array(
        Array(1022226, 1)
    )),
    Array("阿麗莎之光輝",     450, Array(
        Array(1382235, 1)
    )),
    Array("進階貝倫頭盔",  120, Array(
        Array(1003722, 1)
    )),
    Array("解放的凱瑟利安",  450, Array(
        Array(1402180, 1)
    )),
    ...
    Array("南哈特機器人(男)",  400, Array(
        Array(1662064, 1)
    )),
    Array("伊爾卡機器人(男)",  400, Array(
        Array(1662065, 1)
    )),
    Array("西格諾斯機器人(女)",  400, Array(
        Array(1662066, 1)
    )),
    Array("戴米安機器人",  450, Array(
        Array(1662088, 1)
    )),
    Array("阿麗莎機器人",  450, Array(
        Array(1662089, 1)
    )),
    Array("史烏機器人",  450, Array(
        Array(1662092, 1)
    )),
    Array("殺人鯨機器人",  450, Array(
        Array(1662093, 1)
    )),
    Array("露希妲機器人",  500, Array(
        Array(1662111, 1)
    )),
    ...
    Array("V卷軸自選（1張）",  55, Array(
        Array(2435413, 1)
    )),
    Array("X卷軸自選（1張）",  20, Array(
        Array(2434666, 1)
    )),
    Array("X卷軸自選（10張）",  200, Array(
        Array(2431042, 1)
    )),
...
function action(mode, type, selection) {
    ...
    if (status == 0) {
        ...
        var text = "";
        text = ""+iconHR+"尊敬的玩家#b#h ##k，歡迎來到#b#eVIP商城，點擊可以查看禮包內容哦！#n#k\r\n";
        ...
        if (giftId!=-1 && gifts != null) {
            ...
            for(var key in gifts) {
                ...
                if (itemId == -1) {
                    ...
                    cm.gainGachaponItem(itemId, itemQuantity,"VIP商城",3);
                }
            }
            cm.addHyPay(price);
            cm.sendOk("恭喜您，購買成功！");
