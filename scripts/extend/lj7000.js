...
function action(mode, type, selection) {
    ...
    if (mode == -1) {
        ...
        if (status == 0) {
            ...
            txt += "#r [ #h # ] 累計儲值達到 [ 7000 ] 將有豐厚禮品#k\r\n";
            txt += "#b  獎品道具全屬性 [ #e#r150#n#b ] 分別 - 終極MX-131徽章 #r#z1182136# #k\r\n"
            ...
            if (cm.getHyPay(3) >= 7000) {
                if (cm.getEventCount("累計獎品道具終極MX-徽章",1) < 1) {
              ...
              //      toDrop.setTotalDamage(30);//總傷害
               ...
               //     cm.addFromDrop(cm.getC(), toDrop, false);
                    ...
                    cm.spouseMessage(0x23, "※累計超值※：恭喜玩家 " + cm.getChar().getName() + " 領到了超值累計 7000 金額的極品道具【終極MX-131徽章】土豪阿");
                    cm.spouseMessage(0x23, "※累計超值※：恭喜玩家 " + cm.getChar().getName() + " 領到了超值累計 7000 金額的極品道具【終極MX-131徽章】土豪阿");
                    cm.spouseMessage(0x23, "※累計超值※：恭喜玩家 " + cm.getChar().getName() + " 領到了超值累計 7000 金額的極品道具【終極MX-131徽章】土豪阿");
                    cm.spouseMessage(0x23, "※累計超值※：恭喜玩家 " + cm.getChar().getName() + " 領到了超值累計 7000 金額的極品道具【終極MX-131徽章】土豪阿");
                    cm.playerMessage(1, "　" + cm.getChar().getName() + "\r\n\r\n恭喜領到累計超值道具【終極MX-131徽章】\r\n\r\n請聯繫客服幫你設置全150屬性\r\n\r\n感謝你對兔花花的支持 祝您遊戲愉快");
                    cm.setEventCount("累計獎品道具終極MX-徽章", 1);
                    cm.dispose();
                } else {
