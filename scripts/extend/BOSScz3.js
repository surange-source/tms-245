...
var List = Array(
                Array("簡單殘暴炎魔",0,0,4,0,1),//事件名次、所需樂豆點、所需楓幣、能重置的次數、餘額、楓點
                Array("普通殘暴炎魔",1,0,3,0,1),
                Array("進階殘暴炎魔",1,0,3,0,0),
                Array("闇黑龍王",1,0,5,0,0),
                Array("進階闇黑龍王",1,0,4,0,0),
                Array("梅格耐斯[簡單]",1,0,2,0,0),
                Array("梅格耐斯[普通]",1,0,3,0,0),
                Array("梅格耐斯[困難]",1,0,3,0,0),
                Array("魔王巴洛古[簡單]",0,0,2,0,1),
                Array("魔王巴洛古[困難]",0,0,2,0,1),
                Array("希拉",1,0,2,0,0),
                Array("希拉[困難]",1,0,3,0,1),
                Array("獅子王:凡雷恩[簡單]",0,0,4,0,1),
                Array("獅子王:凡雷恩[普通]",1,0,4,0,0),
                Array("鑽機",1,0,2,0,0),
                Array("強化鑽機",1,0,2,0,0),
                Array("皮埃爾",1,0,1,0,0),
                Array("進階皮埃爾",1,0,3,0,1),
                Array("腥血女王",1,0,1,0,0),
                Array("進階腥血女王",1,0,3,0,0),
                Array("貝倫",1,0,1,0,0),
                Array("進階貝倫",1,0,3,0,0),
                Array("半半",1,0,1,0,0),
                Array("進階半半",1,0,3,0,0),
                Array("皮卡啾",1,0,4,0,0),
                Array("混沌皮卡啾",1,0,2,0,0),
                Array("拉圖斯",0,0,2,0,1),
                Array("妖精女王",1,0,2,0,0),
                Array("黃金寺院",1,0,2,0,0),
                Array("阿卡伊農[普通]",1,0,3,0,0),
                Array("女皇：西格諾斯",0,0,3,0,1),
                Array("森蘭丸",1,0,2,0,0),
                Array("桃樂絲",20000,0,4,0,0),
                                Array("濃姬",1, 0, 2, 0, 0),
                Array("貝勒·德",20000,0,3,0,0),
                Array("史烏",20000,0,4,0,0)
);
var round = Array();
var sel;
function start() {
