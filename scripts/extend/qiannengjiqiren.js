...
function action(mode, type, selection) {
    ...
    if (status == 0) {
            var selStr = "#d把機器人兌換卷放進背包，請選擇你要兌換的機器人：#n#k\r\n";
        selStr +="#e#r#L446#"+zs1+"兌換戴米安機器人(三潛)#l#n\r\n\r\n";
        selStr +="#e#r#L447#"+zs1+"兌換史烏機器人(三潛)#l#n\r\n\r\n";
        selStr +="#e#r#L448#"+zs1+"兌換阿麗莎機器人(三潛)#l#n\r\n\r\n";
        selStr +="#e#r#L449#"+zs1+"兌換殺人鯨機器人(三潛能)#l#n\r\n\r\n";
                selStr +="#e#r#L450#"+zs1+"兌換隱月(女)機器人(三潛能)#l#n\r\n\r\n";
        cm.sendSimple(selStr);
    } else if (status == 1) {
        switch (selection) {
        case 446:
            cm.dispose();
            cm.openNpc(1500032,"qiannengdaimian");
            break;
        case 447:
            cm.dispose();
            cm.openNpc(1500032,"qiannengsiwu");
            break;
        case 448:
            cm.dispose();
            cm.openNpc(1500032,"qiannengalisa");
            break;
        case 449:
            cm.dispose();
            cm.openNpc(1500032,"qiannengaoerka");
            break;
        case 450:
            cm.dispose();
            cm.openNpc(1500032,"qiannengyinyue");
            break;
