...
function action(mode, type, selection) {
    ...
    if (status == 0) {
        ...
        switch (selection) {
        case 0:
if(cm.getPQLog("50級獎勵",1) < 1 && (cm.getPlayer().getLevel() > 49 && cm.getPlayer().getLevel() < 255) && (cm.getSpace(5)>1 && cm.getSpace(1)>2)){
...
cm.setPQLog("50級獎勵",1);
cm.sendOk("你成功領取獎勵");
cm.worldSpouseMessage(0x20,"" + cm.getChar().getName() + "玩家成功領取50級獎勵.");
cm.dispose();
} else {
...
cm.dispose();
            ...
            break;
        case 1:
if(cm.getPQLog("100級獎勵",1) < 1 && (cm.getPlayer().getLevel() > 99 && cm.getPlayer().getLevel() < 255) && (cm.getSpace(5)>1 && cm.getSpace(1)>4)){
...
cm.sendOk("你成功領取獎勵");
cm.worldSpouseMessage(0x20,"" + cm.getChar().getName() + "玩家成功領取100級獎勵.");
cm.dispose();
} else {
cm.sendOk("你的等級不滿足條件，或沒有足夠的背包空間\r\n#b(特殊欄3個空位以上).\r\n注:等級獎勵只能領取一次.");
cm.dispose();
            ...
            break;
        case 2:
if(cm.getPQLog("120級獎勵",1) < 1 && (cm.getPlayer().getLevel() > 119 && cm.getPlayer().getLevel() < 255) && (cm.getSpace(5)>1 && cm.getSpace(1)>4)){
...
cm.sendOk("你成功領取獎勵");
cm.worldSpouseMessage(0x20,"" + cm.getChar().getName() + "玩家成功領取120級獎勵.");
cm.dispose();
} else {
cm.sendOk("你的等級不滿足條件，或沒有足夠的背包空間\r\n#b(特殊欄2個空位以上).\r\n注:等級獎勵只能領取一次.");
cm.dispose();
            ...
            break;
        case 3:
if(cm.getPQLog("140級獎勵",1) < 1 && (cm.getPlayer().getLevel() > 139 && cm.getPlayer().getLevel() < 255) && (cm.getSpace(5)>1 && cm.getSpace(1)>5)){
...
cm.sendOk("你成功領取獎勵");
cm.worldSpouseMessage(0x20,"" + cm.getChar().getName() + "玩家成功領取140級獎勵.");
cm.dispose();
} else {
cm.sendOk("你的等級不滿足條件，或沒有足夠的背包空間\r\n#b(所有欄留5個空位以上).\r\n注:等級獎勵只能領取一次.");
cm.dispose();
            ...
            break;
        case 4:
if(cm.getPQLog("160級獎勵",1) < 1 && (cm.getPlayer().getLevel() > 159 && cm.getPlayer().getLevel() < 255) && (cm.getSpace(5)>1 && cm.getSpace(1)>5)){
    cm.gainItem(2431741, 1); //楓點3000
...
cm.sendOk("你成功領取獎勵");
cm.worldSpouseMessage(0x20,"" + cm.getChar().getName() + "玩家成功領取160級獎勵.");
cm.dispose();
} else {
cm.sendOk("你的等級不滿足條件，或沒有足夠的背包空間\r\n#b(其他欄9個空位以上,裝飾欄4個空位以上,特殊欄1個空位以上).#b\r\n注:等級獎勵只能領取一次.");
cm.dispose();
}
            break;
        case 5:
if(cm.getPQLog("180級獎勵",1) < 1 && (cm.getPlayer().getLevel() > 179 && cm.getPlayer().getLevel() < 255) && (cm.getSpace(5)>1 && cm.getSpace(1)>7)){
...
cm.sendOk("你成功領取獎勵");
cm.worldSpouseMessage(0x20,"" + cm.getChar().getName() + "玩家成功領取180級獎勵.");
cm.dispose();
} else {
cm.sendOk("你的等級不滿足條件，或沒有足夠的背包空間\r\n#b(所有欄留7個空位以上).#b\r\n注:等級獎勵只能領取一次.");
cm.dispose();
            ...
            break;
        case 6:
if(cm.getPQLog("200級獎勵",1) < 1 && (cm.getPlayer().getLevel() > 199 && cm.getPlayer().getLevel() < 255) && (cm.getSpace(5)>1 && cm.getSpace(1)>7)){
    cm.gainItem(2431741, 1); //楓點3000
    cm.gainItem(4310129, 10); //冬季限量硬幣
    cm.gainItem(5062002, 5); //高級方塊
    cm.gainItem(5064000, 5); //防爆
...
cm.sendOk("你成功領取獎勵");
cm.worldSpouseMessage(0x20,"" + cm.getChar().getName() + "玩家成功領取200級獎勵.");
cm.dispose();
} else {
cm.sendOk("你的等級不滿足條件，或沒有足夠的背包空間\r\n#b(所有欄留7個空位以上).#b\r\n注:等級獎勵只能領取一次.");
cm.dispose();
            ...
            break;
        case 7:
if(cm.getPQLog("250級獎勵",1) < 1 && (cm.getPlayer().getLevel() > 249 && cm.getPlayer().getLevel() < 255) && (cm.getSpace(5)>1 && cm.getSpace(1)>7)){
...
cm.sendOk("你成功領取獎勵");
cm.worldSpouseMessage(0x20,"" + cm.getChar().getName() + "玩家成功領取250級獎勵.");
cm.dispose();
} else {
cm.sendOk("你的等級不滿足條件，或沒有足夠的背包空間\r\n#b(所有欄留7個空位以上).#b\r\n注:等級獎勵只能領取一次.");
cm.dispose();
