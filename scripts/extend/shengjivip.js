...
function action(mode, type, selection) {
    ...
    if (status == 0) {
            var selStr = "#d把勳章取下放背包，請選擇當前需要晉級的VIP等級：#n#k\r\n";
        selStr +="#e#r#L0#"+"#v1142539#"+"晉級到『VIP2』全屬性+200#l#n\r\n\r\n";
        selStr +="#e#r#L1#"+"#v1142540#"+"晉級到『VIP3』全屬性+300#l#n\r\n\r\n";
        selStr +="#e#r#L2#"+"#v1142541#"+"晉級到『VIP4』全屬性+400#l#n\r\n\r\n";
        selStr +="#e#r#L3#"+"#v1143000#"+"晉級到『VIP5』全屬性+500#l#n\r\n\r\n";
        selStr +="#e#r#L4#"+"#v1142404#"+"晉級到『VIP6』全屬性+600#l#n\r\n\r\n";
                selStr +="#e#r#L5#"+"#v1143012#"+"晉級到『VIP7』全屬性+700(一潛)#l#n\r\n\r\n";
;
        ...
        case 0:
            cm.dispose();
            cm.openNpc(1500032,"shengjivip2");
            break;
        case 1:
            cm.dispose();
            cm.openNpc(1500032,"shengjivip3");
            break;
        case 2:
            cm.dispose();
            cm.openNpc(1500032,"shengjivip4");
            break;
        case 3:
            cm.dispose();
            cm.openNpc(1500032,"shengjivip5");
            break;
        case 4:
            cm.dispose();
            cm.openNpc(1500032,"shengjivip6");
            break;
        case 5:
            cm.dispose();
            cm.openNpc(1500032,"shengjivip7");
            break;
        }
    }
}
