...
var status;
var p;
var ttt1 ="#fCharacter/Cape/01102969.img/info/icon#";//
var ttt2 ="#fCharacter/Cape/01102970.img/info/icon#";// 
var ttt3 ="#fCharacter/Cape/01102971.img/info/icon#";//
var ttt4 ="#fCharacter/Cape/01102863.img/info/icon#";// 
var ttt5 ="#fCharacter/Cape/01102818.img/info/icon#";// 
var ttt6 ="#fCharacter/Cape/01102816.img/info/icon#";// 
...
function action(mode, type, selection) {
    ...
    if (status == 0) {
        ...
        text += "#L0#"+ttt1+" #r門派每日獎勵領取。\r\n";
        //text += "#L3#"+eff+" #d門派首次福利領取。\r\n"
        text += "#L5#"+ttt2+" #d門派任務接取。（完成可獲得活躍度！）\r\n"
        text += "#L1#"+ttt3+" #b購買門派勳章。\r\n"
        text += "#L4#"+ttt4+" #r進入門派基地（門派老大可以召喚出獎勵BOSS！）\r\n"
        text += "#L2#"+ttt5+" #d查看門派成員貢獻度排行。\r\n"
        text += "#L99#"+ttt6+" #b門派系統介紹（貢獻度獲取方式）\r\n";//
        cm.sendSimple(text)
    } else if (status == 1) {
        if (selection == 4) {
            cm.sendOk(" 暫未到開放時間段。");
