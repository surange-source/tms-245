...
var status = 0;
var 購買的屬性裝備 = 1142540;  var 全屬性數值 = 300;
var 需要樂豆點 = 000000;
var 需要道具ID_5 = 1142539;  var 需要數量_5 = 1;
...
function action(mode, type, selection) {
    if (mode == -1) {
        ...
        if (status == 0) {
            ...
            txt += "#b  白銀勳章全屬性 [ 100 ] 分別 - 全屬性裝備 #r#z"+購買的屬性裝備+"# #k\r\n"
           ...
           if (cm.getItemQuantity(需要道具ID_5) >= 需要數量_5&&cm.getItemQuantity(需要道具ID_4) >= 需要數量_4) { 
                    ...
                    var toDrop = cm.getNewEquip(1142540); // 生成一個Equip類 耳環
                ...
                cm.gainItem(需要道具ID_5, -需要數量_5);
                    ...
                    cm.worldSpouseMessage(0x26, "[系統提示] : 恭喜玩家 "+cm.getPlayer().getName()+" 成功兌換VIP3黃金勳章,每日福利多多噢！");
