...
var status = 0;
var 購買的屬性裝備 = 1143012;  var 全屬性數值 = 700;
var 需要樂豆點 = 000000;
var 需要道具ID_5 = 1142404;  var 需要數量_5 = 1;
var 需要道具ID_4 = 2432022;  var 需要數量_4 = 2;
...
newEquip = cm.getEquipBySlot(1);
    ...
    return;
            ...
            txt += "#r [ #h # ] 您好 歡迎來到 #bVIP勳章升級系統 #k\r\n";
            txt += "#b  英雄意志勳章全屬性 [ 600 ] 分別 - 全屬性裝備 #r#z"+購買的屬性裝備+"# #k\r\n"
            txt += "#d       當前擁有#i" + 需要道具ID_4 + "#數量 :#r" + cm.getItemQuantity(需要道具ID_4) + "#d#k#b需要2個\r\n\r\n";
            ...
            if (cm.getItemQuantity(需要道具ID_5) >= 需要數量_5&&cm.getItemQuantity(需要道具ID_4) >= 需要數量_4) {
                    ...
                    var toDrop = cm.getNewEquip(1143012); // 生成一個Equip類 耳環
                ...
                cm.gainItem(需要道具ID_5, -需要數量_5);
                    ...
                    cm.worldSpouseMessage(0x26, "[系統提示] : 恭喜玩家 "+cm.getPlayer().getName()+" 成功兌換VIP7神豪勳章,每日福利多多噢！");
