...
var status = 0;
var choice;
var itemxh=new Array("3010867","3010868","3010869","3010870","3010871","3010872","3010873","3010874","3010875");
var itemxhcost=new Array("100000","100000","100000","100000","100000","100000","100000","100000","100000");
    ...
    if (mode == -1) cm.dispose();
        ...
        choice = selection;
            ...
            cm.gainItem(itemxh[choice], fee);
                cm.worldSpouseMessage(0x0D,"[知己椅子] :  "+ cm.getChar().getName() +"  在樂豆點商店購買了知己椅子!");
            cm.sendOk("恭喜，購買成功。");
            cm.dispose();
             }
        }
