...
var depict = ""; //潛能的描述
var points = -1; //每次的價格
var potline = 5; //修改的潛能是第幾條
var oldEquip;
var newEquip;
var count = 1; //定義洗到那個屬性的次數
var slot = 1; //定義需要修改的裝備在背包的位置
var potline = 5; //定義需要修改的是第幾條潛能 [1-3] 為普通 [4-6] 為附加
var Nx = -1;
...
function action(mode, type, selection) {
    ...
    if (status == 0) {
        var selStr = "#fUI/UIWindow2.img/Quest/quest_info/summary_icon/summary#\r\n\r\n#fUI/UIWindow2.img/QuestAlarm/BtQ/normal/0#親愛的#r#h ##k您好!想選擇什麼樣的潛能:\r\n#k#fUI/UIWindow2.img/QuestAlarm/BtQ/normal/0#擁有青色蠟筆: #r" + cm.itemQuantity(3994421) + "#v3994421##k\r\n\r\n#fUI/UIWindow2.img/QuestGuide/Button/WorldMapQuestToggle/normal/0#";
        for (var i = 0; i < potList.length; i++) {
            selStr += "\r\n#L" + i + "##b#fUI/UIWindow2.img/QuestAlarm/BtQ/normal/0#" + potList[i][1] + "#k  (消耗： #r" + potList[i][2] + "#k #k 青色蠟筆)#l";
        }
    ...
    if(cm.itemQuantity(3994421) < 1) {
        cm.sendOk("請確認背包中是否存在#v3994421##t3994421#");
        cm.dispose();
        return;
    }
