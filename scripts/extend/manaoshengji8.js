...
var 購買的屬性裝備 = 1114212; 
var 需要樂豆點 = 000000;
var 需要道具ID_5 = 4032733;  var 需要數量_5 = 1;
var 需要道具ID_4 = 1114211;  var 需要數量_4 = 1;
...
newEquip = cm.getEquipBySlot(1);
    ...
    return;
            ...
            txt += "#b  初見瑪瑙戒指 [ 400 ] 分別 - 全屬性裝備 #r#z"+購買的屬性裝備+"# #k\r\n"
            ...
            if (cm.getItemQuantity(需要道具ID_5) >= 需要數量_5&&cm.getItemQuantity(需要道具ID_4) >= 需要數量_4) {
                    ...
                    var toDrop = cm.getNewEquip(1114212); // 生成一個Equip類 耳環
                    toDrop.setStr(500); //裝備力量
                    toDrop.setDex(500); //裝備敏捷
                    toDrop.setInt(500); //裝備智力
                    toDrop.setLuk(500); //裝備運氣
                    toDrop.setHp(5000);
                    toDrop.setAcc(100); //命中率
                    toDrop.setMatk(320); //魔法攻擊
                    toDrop.setWatk(320); //攻擊攻擊 
                ...
                cm.gainItem(需要道具ID_5, -需要數量_5);                    
                    ...
                    cm.worldSpouseMessage(0x26, "[系統提示] : 玩家 "+cm.getPlayer().getName()+"通過使用七彩楓葉,終於將瑪瑙戒指提升至  『8』階");
cm.changePotential(1,1, 60005, false);
cm.changePotential(1,4, 60005, false);
cm.changePotential(1,6, 60005, false);
cm.changePotential(1,5, 60005, false);
