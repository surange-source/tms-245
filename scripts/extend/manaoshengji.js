...
function action(mode, type, selection) {
    ...
    if (status == 0) {
            var selStr = "#d把瑪瑙取下放進背包，請選擇當前瑪瑙戒指需要晉級的階級：#n#k\r\n";
        selStr +="#e#r#L0#"+zs1+"晉級到『2』階火焰瑪瑙#l#n\r\n\r\n";
        selStr +="#e#r#L1#"+zs1+"晉級到『3』階閃電瑪瑙#l#n\r\n\r\n";
        selStr +="#e#r#L2#"+zs1+"晉級到『4』階神聖瑪瑙#l#n\r\n\r\n";
        selStr +="#e#r#L3#"+zs1+"晉級到『5』階電子瑪瑙#l#n\r\n\r\n";
        selStr +="#e#r#L4#"+zs1+"晉級到『6』階水神瑪瑙#l#n\r\n\r\n";
        selStr +="#e#r#L5#"+zs1+"晉級到『7』階惡魔瑪瑙#l#n\r\n\r\n";
        selStr +="#e#r#L6#"+zs1+"晉級到『8』階天使瑪瑙#l#n\r\n\r\n";
        selStr +="#e#r#L7#"+zs1+"晉級到『9』階電子瑪瑙#l#n\r\n\r\n";
        selStr +="#e#r#L8#"+zs1+"晉級到『10』階水神瑪瑙#l#n\r\n\r\n";
        selStr +="#e#r#L9#"+zs1+"晉級到『11』階惡魔瑪瑙#l#n\r\n\r\n";
        selStr +="#e#r#L10#"+zs1+"晉級到『12』階天使瑪瑙#l#n\r\n\r\n";
;
        ...
        case 0:
            cm.dispose();
            cm.openNpc(1500032,"manaoshengji2");
            break;
        case 1:
            cm.dispose();
            cm.openNpc(1500032,"manaoshengji3");
            break;
        case 2:
            cm.dispose();
            cm.openNpc(1500032,"manaoshengji4");
            break;
        case 3:
            cm.dispose();
            cm.openNpc(1500032,"manaoshengji5");
            break;
        case 4:
            cm.dispose();
            cm.openNpc(1500032,"manaoshengji6");
            break;
        case 5:
            cm.dispose();
            cm.openNpc(1500032,"manaoshengji7");
            break;
        case 6:
            cm.dispose();
            cm.openNpc(1500032,"manaoshengji8");
            break;
        case 7:
            cm.dispose();
            cm.openNpc(1500032,"manaoshengji9");
            break;
        case 8:
            cm.dispose();
            cm.openNpc(1500032,"manaoshengji10");
            break;
        case 9:
            cm.dispose();
            cm.openNpc(1500032,"manaoshengji11");
            break;
        case 10:
            cm.dispose();
            cm.openNpc(1500032,"manaoshengji12");
            break;
