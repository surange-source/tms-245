...
Array(1113064, 200, 1, 1), //海盜頭巾(粉)
Array(1002394, 300, 1, 1), //海盜頭巾(灰)
Array(1002619, 300, 1, 1), //兵長頭巾
Array(1002622, 300, 1, 1), //水兵帽
Array(1050100, 400, 1, 1), //水兵帽
Array(1050127, 400, 1, 1), //水兵帽
Array(1051098, 400, 1, 1), //水兵帽
Array(1051140, 400, 1, 1), //水兵帽
Array(1051172, 400, 1, 1), //水兵帽
...
// ------ 086添加 ------
//Array(1182016, 300, 1, 1), //黃金休彼德蔓徽章I
//Array(1182017, 200, 1, 1), //黃金休彼德蔓徽章II
Array(1112915, 100, 1, 1), //藍調戒指
Array(1112793, 100, 1, 1), //快樂指環
...
//Array(3994417, 50, 1, 1), //紅蠟筆
//Array(3994418, 50, 1, 1), //紅蠟筆
//Array(3994419, 50, 1, 1), //紅蠟筆
//Array(3994420, 50, 1, 1), //紅蠟筆
//Array(3994421, 50, 1, 1), //紅蠟筆
//Array(3994422, 50, 1, 1), //紅蠟筆
Array(1102730, 100, 1, 1), //濃翅膀
Array(1012172, 100, 1, 1), //娃娃臉
Array(1402014, 100, 1, 1), //溫度計
Array(4000313, 200, 1, 1), //黃金葉子
Array(2431944, 20, 1, 1), //150
Array(2431945, 10, 1, 1),
Array(2431724, 20, 1, 1), //最新椅子箱子
Array(2430217, 20, 1, 1), //貝倫
Array(3015002, 10, 1, 1),//七彩摩天輪
Array(1003422, 80, 1, 1),//石榴石渡鴉面具
Array(2432069, 10, 1, 1), //150
Array(2431988, 10, 1, 1), //150
...
function action(mode, type, selection) {
    ...
    if (status == 0) {
       if (cm.haveItem(5220040, 0)) {
            cm.sendYesNo("            #e"+tz15+"#r『高級轉蛋機』 "+tz15+"\r\n#k免費抽獎「#b背包需要有1個#v5220040#」就可以抽獎1分鐘. 遊戲商城中的「其他」－「遊戲」區裡有噢。#d比普通轉蛋機的幾率要高200%，另外還能抽到普通機裡沒有的物品如下：#k現在要玩轉蛋機麼?\r\n———————————————————————— \r\n#v2432069#(暴君防具箱子)#v2431988#(鷹眼防具箱子)\r\n#v1102724##v1102730##v1012172##v1402014##v3015002##v1003422#");
        } else {
            cm.sendOk("            #e"+tz15+"#r『高級轉蛋機』 "+tz15+"\r\n#k免費抽獎「#b背包需要有1個#v5220040#」就可以抽獎1分鐘. 遊戲商城中的「其他」－「遊戲」區裡有噢。#d比普通轉蛋機的幾率要高200%，另外還能抽到普通機裡沒有的物品如下：#k現在要玩轉蛋機麼?\r\n———————————————————————— \r\n#v1102723#   #v1102730#   #v1012172#   #v1402014#   #v3015002#   #v1003422#\r\n#v2432069#(暴君防具箱子)#v2431988#(鷹眼防具箱子)\r\n你背包裡好像沒有#b5個#t5220040##k哦!請進商城或通過其他活動獲得!");
            cm.safeDispose();
        }
    } else if (status == 1) {
        ...
        if (finalitem.length != 0) {
            ...
            if (cm.haveItem(5220040) && cm.canHold()) {
                if (notice == 1) {
                    cm.gainGachaponItem(itemId, quantity, "免費高級快樂百寶箱");
                } else {
