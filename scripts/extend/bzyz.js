...
var status = 0;
var choice;
var itemxh=new Array("3010978","3010979","3010968","3010814","3010979","3015004","3015003");
var itemxhcost=new Array("200000","200000","200000","200000","200000","200000","200000");
    ...
    if (mode == -1) cm.dispose();
        ...
        choice = selection;
            ...
            cm.gainItem(itemxh[choice], fee);
                cm.worldSpouseMessage(0x0D,"[抱枕椅子] :  "+ cm.getChar().getName() +"  在樂豆點商店購買了抱枕椅子!");
            cm.sendOk("恭喜，購買成功。");
            cm.dispose();
             }
        }
