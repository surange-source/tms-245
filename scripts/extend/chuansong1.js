...
function action(mode, type, selection) {
    ...
    if (status == 0) {
        cm.sendSimple("#L0#" + eff + "城鎮傳送#l\r\n#L1#" + eff + "快速練級#l\r\n#L4#" + eff + "BOSS傳送#l\r\n#L20#" + eff + "小怪獸傳送#l\r\n#L5#" + eff + "#r【美容美發】#k洗剪吹 #d#e(市場7洞免費換髮型及整容)#n#l\r\n#L8#" + eff + "#r【休閒娛樂】#k跳圖-無獎勵#l\r\n#L7#" + eff + "#r【公會中心】#k(創建公會或者公會聯盟)#l\r\n#L18#" + eff + "#r【美洲豹棲息地】#k抓你想要的豹子#b#l");
        } else if (status == 1) {
