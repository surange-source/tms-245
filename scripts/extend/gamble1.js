...
function action(mode, type, selection) {
    if (mode == -1) {
        ...
        if (status == 0) {
            ...
            add += "" + xxx + "-當前下注押金:#b<#e#r 樂豆點賭博 #n#b>#b<#e#r " + cost + " 樂豆點#n#b >#k\r\n ";
            add += "" + xxx + "-當前您擁有樂豆點：" + cm.getPlayer().getCSPoints(1) + ".#k\r\n";
            ...
            if (selection == 0) {
                cm.sendOk("#b成功加注#r1000樂豆點#b,請點確定後查看.");
                cost = cost + 1000
                status = -1;
            }else if (selection == 5) {
                cm.sendOk("#b成功加注#r10000樂豆點#b,請點確定後查看.");
                cost = cost + 10000
                status = -1;
            } else if (selection == 1) {
                var add = "#b<#e#r 樂豆點賭博 #n#b>\r\n\r\n";
                add += "" + ttt + "-您選擇的是[#r賠率1:1#b].\r\n";
                add += "" + ttt + "-您的押注為[#r" + cost + "樂豆點#b].\r\n";
                add += "" + ttt + "-如果勝利將獲取[#r除本金外" + cost * 1 + "樂豆點#b]的獎勵.\r\n";
                ...
                add += "" + ttt + "-您的押注為[#r" + cost + "樂豆點#b].\r\n";
                add += "" + ttt + "-如果勝利將獲取[#r除本金外" + cost * 2 + "樂豆點#b]的獎勵.\r\n";
                add += "" + ttt + "-點擊[#r是#b]開始賭博,點擊[#r不是#b]放棄賭博.";
                cm.sendYesNo(add);
                jilv = 2;
                xx = 0
                ...
                add += "" + ttt + "-您的押注為[#r" + cost + "樂豆點#b].\r\n";
                add += "" + ttt + "-如果勝利將獲取[#r除本金外" + cost * 3 + "樂豆點#b]的獎勵.\r\n";
                add += "" + ttt + "-點擊[#r是#b]開始賭博,點擊[#r不是#b]放棄賭博.";
                cm.sendYesNo(add);
                jilv = 3;
                xx = 0
                ...
                if (jilv == 0) {} else if (jilv != 0) {
                    if (cm.getPlayer().getCSPoints(1) < cost) {
                        ...
                        if (jiaru == 0) {
                            costa = cost * jilv
                            cm.gainNX(costa);
                            cm.worldSpouseMessage(0x0D, "[博彩公告]:" + "  恭喜玩家：" + cm.getPlayer().getName() + " 在樂豆點博彩中贏得" + costa + "樂豆點。");
