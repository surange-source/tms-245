...
function action(mode, type, selection) {
    if (mode == -1) {
        ...
        if (mode == 1)
            ...
            status--;
        if (status == 0) {
            var selStr = "我這裡是將1W石頭換成百萬的：#n#b\r\n";
            selStr +="#L1#回收#r#z2614000#100個#b 獲得#z2614002##l\r\n";
            selStr +="#L2#回收#r#z2614006#100個#b 獲得#z2614008##l\r\n";
            selStr +="#L3#回收#r#z2614012#100個#b 獲得#z2614014##l\r\n";
            ...
            if (selection == 1) {
                typed=1;
                cm.sendYesNo("#b- 你確定回收100個#r#z2614000##b嗎？你將來獲得#z2614002#\r\n");
            } else if (selection == 2) {
                typed=2;
                cm.sendYesNo("#b- 你確定回收100個#r#z2614006##b嗎？你將來獲得#z2614008#\r\n");
                        } else if (selection == 3) {
                typed=3;
                cm.sendYesNo("#b- 你確定回收100個#r#z2614012##b嗎？你將來獲得#z2614014#\r\n");
                        } else if (selection == 4) {
                typed=4;
            ...
            if(typed==1){
                if (cm.haveItem(2614000, 100)) {
            cm.gainItem(2614002,1);
            cm.gainItem(2614000, -100);
            cm.sendOk("兌換成功.");
            ...
            cm.dispose();
                 ...
                 if (cm.haveItem(2614006, 100)) {
            cm.gainItem(2614008,1);
            cm.gainItem(2614006, -100);
            cm.sendOk("兌換成功.");
            ...
            cm.dispose();
                 ...
                 if (cm.haveItem(2614012, 100)) {
            cm.gainItem(2614014,1);
            cm.gainItem(2614012, -100);
            cm.sendOk("兌換成功.");
