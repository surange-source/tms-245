...
var 購買的屬性裝備 = 1114221; 
var 需要樂豆點 = 000000;
var 需要道具ID_3 = 4000051;  var 需要數量_3 = 4000;
var 需要道具ID_4 = 1114201;  var 需要數量_4 = 1;
var 需要道具ID_2 = 4000448;  var 需要數量_2 = 4000;
...
function action(mode, type, selection) {
    if (mode == -1) {
        ...
        if (status == 0) {
            ...
            txt += "#b  初見瑪瑙戒指 [ 70 ] 分別 - 全屬性裝備 #r#z"+購買的屬性裝備+"# #k\r\n"
            ...
            txt += "#d      當前擁有#i" + 需要道具ID_2 + "#數量 :#r" + cm.getItemQuantity(需要道具ID_2) + "#d#k#b需要4000個\r\n\r\n";
            txt += "　　　　　　　　　　　　 #i"+購買的屬性裝備+"# 　　　　　　　　　　\r\n\r\n";
            ...
            if (cm.getItemQuantity(需要道具ID_3) >= 需要數量_3&&cm.getItemQuantity(需要道具ID_4) >= 需要數量_4&&cm.getItemQuantity(需要道具ID_2) >= 需要數量_2) {
               
                    var ii = cm.getItemInfo();
                    var toDrop = cm.getNewEquip(1114221); // 生成一個Equip類 耳環
                    toDrop.setStr(110); //裝備力量
                    toDrop.setDex(110); //裝備敏捷
                    toDrop.setInt(110); //裝備智力
                    toDrop.setLuk(110); //裝備運氣
                    toDrop.setHp(900);
                    toDrop.setAcc(100); //命中率
                    toDrop.setMatk(75); //魔法攻擊
                    toDrop.setWatk(75); //攻擊攻擊 
                ...
                cm.gainItem(需要道具ID_3, -需要數量_3);
                    ...
                    cm.worldSpouseMessage(0x26, "[系統提示] : 玩家 "+cm.getPlayer().getName()+"經過爆肝般的努力,終於將瑪瑙戒指提升至  『3』階");
