...
var 需要道具ID_4 = 1114227;  var 需要數量_4 = 1;
...
newEquip = cm.getEquipBySlot(1);
    ...
    return;
            ...
            txt += "#b  初見瑪瑙戒指 [ 600 ] 分別 - 全屬性裝備 #r#z"+購買的屬性裝備+"# #k\r\n"
            ...
            if (cm.getItemQuantity(需要道具ID_5) >= 需要數量_5&&cm.getItemQuantity(需要道具ID_4) >= 需要數量_4) {
                    ...
                    var toDrop = cm.getNewEquip(1114228); // 生成一個Equip類 耳環
                    toDrop.setStr(700); //裝備力量
                    toDrop.setDex(700); //裝備敏捷
                    toDrop.setInt(700); //裝備智力
                    toDrop.setLuk(700); //裝備運氣
                    toDrop.setHp(7000);
                    toDrop.setAcc(100); //命中率
                    toDrop.setMatk(460); //魔法攻擊
                    toDrop.setWatk(460); //攻擊攻擊 
                ...
                cm.gainItem(需要道具ID_5, -需要數量_5);                    
                    ...
                    cm.worldSpouseMessage(0x26, "[系統提示] : 玩家 "+cm.getPlayer().getName()+"通過使用專屬色子,終於將瑪瑙戒指封印解除了,提升至  『10』階");
