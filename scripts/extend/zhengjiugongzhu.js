...
function action(mode, type, selection) {
    ...
    if (status == 0) {
      ...
      cm.setPQLog("Heros");
       cm.sendOk("獲取了 #v"+psrw[rand][0]+"# "+psrw[rand][1]+"個，#b冬季限量幣#k50個，#b征服者幣#k50個，#b高級巨人秘藥#k1個，#b高級神奇方塊#k1個。");
    cm.worldSpouseMessage(0x20, "『英雄救美』" + " : " + "[" + cm.getChar().getName() + "]獲得了1個隨機物品<冬季限量幣50個，征服者幣50個,高級巨人秘藥1個，高級神奇方塊1個>,快去挑戰吧");
       cm.dispose(); 
    }
        }
        }
