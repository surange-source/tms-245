...
var maxPartySize = 6;
var XZ;
var name0 = "[系列]馬加提亞組隊任務";
var name = Array(
        Array("[執行]馬加提亞-蒙特鳩實驗室A","蒙特鳩實驗室A","NewEvent22",100,220),//執行顯示的名字、事件記錄、事件腳本名稱、帳號次數、怪物等級
        Array("[執行]馬加提亞-卡帕萊特的實驗室A","卡帕萊特的實驗室A","NewEvent23",100,190),
        Array("[執行]馬加提亞-蒙特鳩實驗室B","蒙特鳩實驗室B","NewEvent24",100,160),
        Array("[執行]馬加提亞-卡帕萊特的實驗室B","卡帕萊特的實驗室B","NewEvent25",100,200)
);
