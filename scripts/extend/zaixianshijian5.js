...
// 每個禮包所需的在線時長
var condition = new Array(30, 60, 120, 180, 240,360,480,600,720,1080,1200);
...
//600
    Array(8, 2000005, 100),
    Array(8, 2710000, 10),
    Array(8, 2711003, 5),//xingxing
    //Array(8, 4310110, 5),//chunjieb
    //Array(8, 2049323, 2),//wusun
    Array(8, 2711004, 5),
    //Array(8, 2049752, 1),
    Array(8, 2854002, 2),//baiyi
    //Array(8, 4001714, 2),//Sqianneng
    //Array(8, 4001714, 5),//dingjujin
    Array(8, 4310036, 1),//祝福卷
    Array(8, 4310038, 1),//fangbao
    //Array(8, 5062009, 6),                   
    //Array(8, 5062500, 6),//dashimofang
    //Array(8, 5062002, 8),//高級生氣方塊
...
//1080
    Array(10, 2000005, 200),
    Array(10, 2710000, 10),
    Array(10, 2711003, 12),
    Array(10, 2711004, 12),
    Array(10, 2854002, 3),
    Array(10, 5743003, 1),                     
    //Array(10, 4001832, 1000),
    //Array(10, 2460003, 20),
    //Array(10, 5062000, 15),//組墨綠箱子
    //Array(10, 2854002, 20),
    //Array(10, 5743003, 20),
    
    
//1200
    Array(11, 2000005, 400),
    Array(11, 2710000, 10),
    Array(11, 2711003, 12),
    Array(11, 2711004, 12),
    Array(11, 2854002, 5),
