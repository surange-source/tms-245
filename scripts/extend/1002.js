...
function action(mode, type, selection) {
    ...
    if (status == 0) {
        var selStr = "#fUI/UIWindow2.img/Quest/quest_info/summary_icon/summary#\r\n\r\n親愛的#r#h ##k您好!想選擇什麼樣的潛能:\r\n#k擁有紅色蠟筆: #r" + cm.itemQuantity(3994417) + "#v3994417##k\r\n\r\n";
        for (var i = 0; i < potList.length; i++) {
            selStr += "\r\n#L" + i + "##b " + potList[i][1] + "#k  \r\n\t#d(需消耗： #r" + potList[i][2] + "#k #k#d #z3994417#)#l\r\n";
        }
        cm.sendSimple(selStr + " \r\n ");
    } else if (status == 1) {
        oldEquip = cm.getEquipBySlot(slot);
        if (oldEquip == null && oldEquip.getState() != 0x14) { //oldEquip.getState() != 0x14 檢測裝備普通潛能是否 SS
