...
var hairnew = Array();
var mface = Array(20035,20147,20046,20462,20377,23071,20092,20091,23043,23042,23041,24016,20044,20038,20035, 20047, 20098, 23059, 24057, 23053, 21099, 23057,  23033, 23034, 23029, 23030, 24025, 24015, 23025, 23019, 23014, 23024, 23017, 23015, 23110, 23021, 23016, 24011, 24012, 20099, 24001, 23004, 21092, 20000, 20001, 20002, 20003, 20004, 20005, 20006, 20007, 20008, 20009, 20010, 20011, 20012, 20013, 20014, 20015, 20016, 20017, 20018, 20019, 20020, 20021, 20022, 20023, 20024, 20025, 20026, 20027, 20028, 20029, 20036, 20045, 20037, 20040, 20048, 20049, 20050, 20051, 20052, 20053, 20055, 20056, 20058, 20059, 20060, 20062, 20063, 20064, 20065, 20066, 20068, 20067, 20069);
var fface = Array(24050,24057,23053,23054,23064,23060,24058,24020,24013,24015,23831,24126,23028,24070,24168,24059,23060,23064,23153,23059,23753,23056,23057,24056,24052,24035,24041,24040,24039,24038,24036,23034,23040,24032,24031,21036,24028,23808,24025,23030,23029,24722,23032,21444,21131,21033,21145,21175,21180,21179,21177,21178,21193,21065,21000, 21001, 21002, 21003, 21004, 21005, 21006, 21007, 21008, 21009, 21010, 21011, 21012, 21013, 21014, 21015, 21016, 21017, 21018, 21019, 21020, 21021, 21022, 21023, 21024, 21025, 21026, 21027, 21034, 21043, 21029, 21030, 21038, 21046, 21047, 21048, 21049, 21050, 21052, 21053, 21054, 21055, 21056, 21057, 21058, 21059, 21060, 21061, 21062, 21064);
var facenew = Array();
    ...
    if (mode == -1) {
        ...
        if (status == 0) {
            ...
            if (selection == 0) {
                ...
                cm.sendStyle("我可以改變你的臉型,讓它比現在看起來漂亮. 你為什麼不試著改變它下? ,我將會幫你改變你的臉型,那麼選擇一個你想要的新臉型吧!", facenew, 5152001,false);
            } else if (selection == 1) {
                beauty = 1;
                if (cm.getChar().getGender() == 0) {
                ...
                cm.sendStyle("請選擇你喜歡的顏色.", colors, 5152001,false);
            } else if (selection == 2) {
                beauty = 2;
                haircolor = Array();
                ...
                cm.sendStyle("我可以改變你的髮色,讓它比現在看起來漂亮. 你為什麼不試著改變它下? 我將會幫你改變你的髮色,那麼選擇一個你想要的新髮色吧!", haircolor, 5151001,false);
                ...
                cm.sendStyle("我可以改變你的髮型,讓它比現在看起來漂亮.你為什麼不試著改變它下? 我將會幫你改變你的髮型,那麼選擇一個你想要的新髮型吧!", hairnew, 5150001,false);
            } else if (selection == 4) {
                beauty = 4;
