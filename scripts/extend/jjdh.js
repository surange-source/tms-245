...
function action(mode, type, selection) {
 ...
 if (status == 0){
                var selStr ="\r\n#e#d             "+tz+""+"結晶兌換中心"+tz+"#n#l#k";
            selStr +="\r\n#L555#"+iconEvent+" #e低級結晶兌換#l   \r\n";
            selStr +="#L556#"+iconEvent+" #e中級結晶兌換#l   \r\n";
            selStr +="#L557#"+iconEvent+" #e高級結晶兌換#l   \r\n";
        cm.sendSimple(selStr);
    } else if (status == 1) {
        switch (selection) {
        case 555:
            cm.dispose();
            cm.openNpc(9900003, "jjdh1");
            break;
        case 556:
            cm.dispose();
            cm.openNpc(9900003, "jjdh2");
            break;
        case 557:
            cm.dispose();
            cm.openNpc(9900003, "jjdh3");
            break;
