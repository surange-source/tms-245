...
var BOSSMAP = Array(328024000,-1048,-220);//亂入出現的地圖、X坐標、Y坐標
...
function setup(level, leaderid) {
    ...
    var map = eim.setInstanceMap(328026000);
    map.resetFully();
    var mob = em.getMonster(2600710);
    mob.changeLevel(level);
    mob.getChangedStats().setOHp(325000000000);
    mob.setHp(325000000000);
    eim.registerMonster(mob);
    map.spawnMonsterOnGroundBelow(mob, new java.awt.Point(-51,180));
    //----以下為BOSS亂入召喚
...
function allMonstersDead(eim) {
    ...
    eim.getMapInstance(328026000).spawnNpc(9390445, new java.awt.Point(-51,180));
}
