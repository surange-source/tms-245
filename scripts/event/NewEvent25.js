...
var BOSSMAP = Array(326044000,878,225);//亂入出現的地圖、X坐標、Y坐標
...
function setup(level, leaderid) {
    ...
    var map = eim.setInstanceMap(326046000);
    map.resetFully();
    var mob = em.getMonster(9300788);
    mob.changeLevel(level);
    mob.getChangedStats().setOHp(1650000000);
    mob.setHp(1650000000);
    eim.registerMonster(mob);
    map.spawnMonsterOnGroundBelow(mob, new java.awt.Point(523,166));
    //----以下為BOSS亂入召喚
...
function allMonstersDead(eim) {
    ...
    eim.getMapInstance(326046000).spawnNpc(9390445, new java.awt.Point(523,166));
}
