...
var BOSSMAP = Array(322023000,816,274);//亂入出現的地圖、X坐標、Y坐標
...
function setup(level, leaderid) {
    ...
    var map = eim.setInstanceMap(322026000);
    map.resetFully();
    var mob = em.getMonster(3220001);
    mob.changeLevel(level);
    mob.getChangedStats().setOHp(525000000);
    mob.setHp(525000000);
    eim.registerMonster(mob);
    map.spawnMonsterOnGroundBelow(mob, new java.awt.Point(240,214));
    //----以下為BOSS亂入召喚
...
function allMonstersDead(eim) {
    ...
    eim.getMapInstance(322026000).spawnNpc(9390445, new java.awt.Point(240,214));
}
