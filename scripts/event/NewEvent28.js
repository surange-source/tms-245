...
var BOSSMAP = Array(327034000,102,2577);//亂入出現的地圖、X坐標、Y坐標
...
function setup(level, leaderid) {
    ...
    var eim = em.newInstance("NewEvent28");
    ...
    var map = eim.setInstanceMap(327036000);
    map.resetFully();
    var mob = em.getMonster(9420544);
    mob.changeLevel(level);
    mob.getChangedStats().setOHp(12500000000);
    mob.setHp(12500000000);
    eim.registerMonster(mob);
    map.spawnMonsterOnGroundBelow(mob, new java.awt.Point(-218,2577));
    //----以下為BOSS亂入召喚
...
function allMonstersDead(eim) {
    ...
    eim.getMapInstance(327036000).spawnNpc(9390445, new java.awt.Point(-218,2577));
}
