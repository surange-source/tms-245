...
var BOSSMAP = Array(324054000,-223,-94);//亂入出現的地圖、X坐標、Y坐標
...
function setup(level, leaderid) {
    ...
    var map = eim.setInstanceMap(324056000);
    map.resetFully();
    var mob = em.getMonster(9300106);
    mob.changeLevel(level);
    mob.getChangedStats().setOHp(950000000);
    mob.setHp(950000000);
    eim.registerMonster(mob);
    map.spawnMonsterOnGroundBelow(mob, new java.awt.Point(364,69));
    //----以下為BOSS亂入召喚
...
function allMonstersDead(eim) {
    ...
    eim.getMapInstance(324056000).spawnNpc(9390445, new java.awt.Point(364,69));
}
