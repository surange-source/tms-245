...
var BOSSMAP = Array(321114000,554,391);//亂入出現的地圖、X坐標、Y坐標
var BOSSChance = 25;//（數字÷500）×100%
function init() {
    em.setProperty("state", "0");//state = 為1代表有沒有人，2代表是否有BOSS亂入
...
function setup(level, leaderid) {
    ...
    map.resetFully();
    var mob = em.getMonster(9300291);
    mob.changeLevel(level);
    mob.getChangedStats().setOHp(1250000000);
    mob.setHp(1250000000);
    ...
    if (chance<BOSSChance||em.getProperty("leader")=="true"){
        ...
        eim.getMapInstance(0).startMapEffect("注意：米納爾西部森林 "+C[2]+" 級BOSS亂入", 5120031);
    }
...
function playerEntry(eim, player) {
    ...
    //em.broadcastServerMsg(5121027, "玩家進入神木村-米納爾西部森林副本，請在30分鐘內通關拿到獎勵！" ,true);
}
...
function allMonstersDead(eim) {
    ...
    eim.getMapInstance(321116000).spawnNpc(9390445, new java.awt.Point(-57, 391));
