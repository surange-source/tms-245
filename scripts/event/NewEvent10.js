...
var BOSSMAP = Array(323023000,831,184);//亂入出現的地圖、X坐標、Y坐標
...
function setup(level, leaderid) {
    ...
    var map = eim.setInstanceMap(323026000);
    map.resetFully();
    var mob = em.getMonster(8220007);
    mob.changeLevel(level);
    mob.getChangedStats().setOHp(105000000);
    mob.setHp(105000000);
    eim.registerMonster(mob);
    map.spawnMonsterOnGroundBelow(mob, new java.awt.Point(1099,94));
    //----以下為BOSS亂入召喚
...
function allMonstersDead(eim) {
    ...
    eim.getMapInstance(323026000).spawnNpc(9390445, new java.awt.Point(1099,94));
}
