...
var BOSSMAP = Array(321133000,-132,-359);//亂入出現的地圖、X坐標、Y坐標
...
function setup(level, leaderid) {
    ...
    var map = eim.setInstanceMap(321136000);
    map.resetFully();
    var mob = em.getMonster(9300293);
    mob.changeLevel(level);
    mob.getChangedStats().setOHp(32500000000);
    mob.setHp(32500000000);
    eim.registerMonster(mob);
    map.spawnMonsterOnGroundBelow(mob, new java.awt.Point(-287,-239));
    //----以下為BOSS亂入召喚
    ...
    if (chance<BOSSChance||em.getProperty("leader")=="true"){
        ...
        eim.getMapInstance(0).startMapEffect("注意：黃昏之林 "+C[2]+" 級BOSS亂入", 5120031);
    }
...
function allMonstersDead(eim) {
    ...
    eim.getMapInstance(321136000).spawnNpc(9390445, new java.awt.Point(-287,-239));
}
