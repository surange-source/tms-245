/*  This is mada by wsy    
 *  This source is made by Team wsy
 *  功能：海盜
 *  @wsy小妤 
 */
var minPlayers = 2;
...
function pickUpItem(eim, player, itemID) {
    switch (itemID) {
        ...
        case 4001122:
            ...
            if (tt == stats) {
                player.dropTopMsg("收集到了" + count + "個" + (tt == 0 ? "初級" : tt == 1 ? "中級" : "高級") + "海盜。");
                if (count >= 20) {
                    ...
                    eim.schedule("checkPQDone", 100);
                    eim.getMapInstance(1).startMapEffect(stats == 2 ? "現在快進入下一個階段吧!!" : "好的現在進行收集下一種證物。", 5120020);
                }
            }
