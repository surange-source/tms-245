...
var BOSSMAP = Array(322034000,599,-146);//亂入出現的地圖、X坐標、Y坐標
...
function setup(level, leaderid) {
    ...
    var map = eim.setInstanceMap(322036000);
    map.resetFully();
    var mob = em.getMonster(9300477);
    mob.changeLevel(level);
    mob.getChangedStats().setOHp(825000000);
    mob.setHp(825000000);
    eim.registerMonster(mob);
    map.spawnMonsterOnGroundBelow(mob, new java.awt.Point(1048,-146));
    //----以下為BOSS亂入召喚
...
function allMonstersDead(eim) {
    ...
    eim.getMapInstance(322036000).spawnNpc(9390445, new java.awt.Point(1048,-146));
}
