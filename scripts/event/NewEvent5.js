...
var BOSSMAP = Array(322014000,-303,274);//亂入出現的地圖、X坐標、Y坐標
...
function setup(level, leaderid) {
    ...
    var map = eim.setInstanceMap(322016000);
    map.resetFully();
    var mob = em.getMonster(8090000);
    mob.changeLevel(level);
    mob.getChangedStats().setOHp(325000000);
    mob.setHp(325000000);
    eim.registerMonster(mob);
    map.spawnMonsterOnGroundBelow(mob, new java.awt.Point(-121,274));
    //----以下為BOSS亂入召喚
...
function allMonstersDead(eim) {
    ...
    eim.getMapInstance(322016000).spawnNpc(9390445, new java.awt.Point(-121,274));
}
