...
var BOSSMAP = Array(323034000,-109,115);//亂入出現的地圖、X坐標、Y坐標
...
function setup(level, leaderid) {
    ...
    var map = eim.setInstanceMap(323036000);
    map.resetFully();
    var mob = em.getMonster(9303083);
    mob.changeLevel(level);
    mob.getChangedStats().setOHp(135000000);
    mob.setHp(135000000);
    eim.registerMonster(mob);
    map.spawnMonsterOnGroundBelow(mob, new java.awt.Point(434,-203));
    //----以下為BOSS亂入召喚
...
function allMonstersDead(eim) {
    ...
    eim.getMapInstance(323036000).spawnNpc(9390445, new java.awt.Point(434,-203));
}
