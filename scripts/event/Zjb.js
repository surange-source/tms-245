...
function setup(eim, leaderid) {
    ...
    map.resetFully();
    eim.getMapFactoryMap(913051201).killAllMonsters(false);
    var mob = em.getMonster(9600172);
    mob.getStats().setHp(mob.getMobMaxHp() * 200);
    mob.getStats().setMp(mob.getMobMaxMp() * 20000);
...
function allMonstersDead(eim) {
    //em.broadcastServerMsg(5120027, "梅格耐斯已被消滅，請在1分鐘內點擊NPC獲得獎勵。" ,true);
