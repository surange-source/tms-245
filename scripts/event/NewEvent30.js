...
var BOSSMAP = Array(328014000,159,180);//亂入出現的地圖、X坐標、Y坐標
...
function setup(level, leaderid) {
    ...
    var map = eim.setInstanceMap(328016000);
    map.resetFully();
    var mob = em.getMonster(2600705);
    mob.changeLevel(level);
    mob.getChangedStats().setOHp(325000000000);
    mob.setHp(325000000000);
    eim.registerMonster(mob);
    map.spawnMonsterOnGroundBelow(mob, new java.awt.Point(324,180));
    //----以下為BOSS亂入召喚
...
function allMonstersDead(eim) {
    ...
    eim.getMapInstance(328016000).spawnNpc(9390445, new java.awt.Point(324,180));
}
