...
var BOSSMAP = Array(325034000,2341,17);//亂入出現的地圖、X坐標、Y坐標
...
function setup(level, leaderid) {
    ...
    var map = eim.setInstanceMap(325036000);
    map.resetFully();
    var mob = em.getMonster(5220000);
    mob.changeLevel(level);
    mob.getChangedStats().setOHp(1450000000);
    mob.setHp(1450000000);
    eim.registerMonster(mob);
    map.spawnMonsterOnGroundBelow(mob, new java.awt.Point(2105,17));
    //----以下為BOSS亂入召喚
...
function allMonstersDead(eim) {
    ...
    eim.getMapInstance(325036000).spawnNpc(9390445, new java.awt.Point(2105,17));
}
