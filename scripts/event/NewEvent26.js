...
var BOSSMAP = Array(327014000,889,131);//亂入出現的地圖、X坐標、Y坐標
...
function setup(level, leaderid) {
    ...
    var map = eim.setInstanceMap(327016000);
    map.resetFully();
    var mob = em.getMonster(9300299);
    mob.changeLevel(level);
    mob.getChangedStats().setOHp(250000000);
    mob.setHp(250000000);
    eim.registerMonster(mob);
    map.spawnMonsterOnGroundBelow(mob, new java.awt.Point(2294,161));
    //----以下為BOSS亂入召喚
...
function allMonstersDead(eim) {
    ...
    eim.getMapInstance(327016000).spawnNpc(9390445, new java.awt.Point(2294,161));
}
