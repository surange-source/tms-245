...
var BOSSMAP = Array(325023000,1850,-393);//亂入出現的地圖、X坐標、Y坐標
...
function setup(level, leaderid) {
    ...
    var map = eim.setInstanceMap(325026000);
    map.resetFully();
    var mob = em.getMonster(8220001);
    mob.changeLevel(level);
    mob.getChangedStats().setOHp(1250000000);
    mob.setHp(1250000000);
    eim.registerMonster(mob);
    map.spawnMonsterOnGroundBelow(mob, new java.awt.Point(1616,-573));
    //----以下為BOSS亂入召喚
...
function allMonstersDead(eim) {
    ...
    eim.getMapInstance(325026000).spawnNpc(9390445, new java.awt.Point(1616,-573));
}
