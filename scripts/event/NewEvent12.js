...
var BOSSMAP = Array(323043000,613,129);//亂入出現的地圖、X坐標、Y坐標
...
function setup(level, leaderid) {
    ...
    var map = eim.setInstanceMap(323046000);
    map.resetFully();
    var mob = em.getMonster(8130100);
    mob.changeLevel(level);
    mob.getChangedStats().setOHp(215000000);
    mob.setHp(215000000);
    eim.registerMonster(mob);
    map.spawnMonsterOnGroundBelow(mob, new java.awt.Point(869,99));
    //----以下為BOSS亂入召喚
...
function allMonstersDead(eim) {
    ...
    eim.getMapInstance(323046000).spawnNpc(9390445, new java.awt.Point(869,99));
}
