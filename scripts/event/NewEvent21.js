...
var BOSSMAP = Array(325044000,-2799,-45);//亂入出現的地圖、X坐標、Y坐標
...
function setup(level, leaderid) {
    ...
    var map = eim.setInstanceMap(325046000);
    map.resetFully();
    var mob = em.getMonster(2600622);
    mob.changeLevel(level);
    mob.getChangedStats().setOHp(1650000000);
    mob.setHp(1650000000);
    eim.registerMonster(mob);
    map.spawnMonsterOnGroundBelow(mob, new java.awt.Point(2367,15));
    //----以下為BOSS亂入召喚
...
function allMonstersDead(eim) {
    ...
    eim.getMapInstance(325046000).spawnNpc(9390445, new java.awt.Point(2367,15));
}
