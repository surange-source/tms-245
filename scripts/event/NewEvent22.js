...
var BOSSMAP = Array(326014000,286,312);//亂入出現的地圖、X坐標、Y坐標
...
function setup(level, leaderid) {
    ...
    var map = eim.setInstanceMap(326016000);
    map.resetFully();
    var mob = em.getMonster(2600504);
    mob.changeLevel(level);
    mob.getChangedStats().setOHp(1050000000);
    mob.setHp(1050000000);
    eim.registerMonster(mob);
    map.spawnMonsterOnGroundBelow(mob, new java.awt.Point(1041,213));
    //----以下為BOSS亂入召喚
...
function allMonstersDead(eim) {
    ...
    eim.getMapInstance(326016000).spawnNpc(9390445, new java.awt.Point(1041,213));
}
