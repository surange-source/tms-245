...
var BOSSMAP = Array(328034000,-187,-571);//亂入出現的地圖、X坐標、Y坐標
...
function setup(level, leaderid) {
    ...
    var map = eim.setInstanceMap(328036000);
    map.resetFully();
    var mob = em.getMonster(2600715);
    mob.changeLevel(level);
    mob.getChangedStats().setOHp(325000000000);
    mob.setHp(325000000000);
    eim.registerMonster(mob);
    map.spawnMonsterOnGroundBelow(mob, new java.awt.Point(211,180));
    //----以下為BOSS亂入召喚
...
function changedMap(eim, player, mapid) {
    if (mapid < 328036000 || mapid > 328036000) {
...
function allMonstersDead(eim) {
    ...
    eim.getMapInstance(328036000).spawnNpc(9390445, new java.awt.Point(211,180));
}
