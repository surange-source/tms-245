...
var BOSSMAP = Array(324024000,1868,-628);//亂入出現的地圖、X坐標、Y坐標
...
function setup(level, leaderid) {
    ...
    var map = eim.setInstanceMap(324026000);
    map.resetFully();
    var mob = em.getMonster(7220002);
    mob.changeLevel(level);
    mob.getChangedStats().setOHp(350000000);
    mob.setHp(350000000);
    eim.registerMonster(mob);
    map.spawnMonsterOnGroundBelow(mob, new java.awt.Point(1693,-88));
    //----以下為BOSS亂入召喚
...
function allMonstersDead(eim) {
    ...
    eim.getMapInstance(324026000).spawnNpc(9390445, new java.awt.Point(1693,-88));
}
