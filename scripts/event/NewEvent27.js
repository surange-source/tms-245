...
var BOSSMAP = Array(327024000,498,1031);//亂入出現的地圖、X坐標、Y坐標
...
function setup(level, leaderid) {
    ...
    var map = eim.setInstanceMap(327026000);
    map.resetFully();
    ...
    map.spawnMonsterOnGroundBelow(mob, new java.awt.Point(-114,1031));
    //----以下為BOSS亂入召喚
...
function allMonstersDead(eim) {
    ...
    eim.getMapInstance(327026000).spawnNpc(9390445, new java.awt.Point(-114,1031));
}
