...
var BOSSMAP = Array(324044000,291,122);//亂入出現的地圖、X坐標、Y坐標
...
function setup(level, leaderid) {
    ...
    var map = eim.setInstanceMap(324046000);
    map.resetFully();
    var mob = em.getMonster(7220001);
    mob.changeLevel(level);
    mob.getChangedStats().setOHp(750000000);
    mob.setHp(750000000);
    eim.registerMonster(mob);
    map.spawnMonsterOnGroundBelow(mob, new java.awt.Point(1013,169));
    //----以下為BOSS亂入召喚
...
function allMonstersDead(eim) {
    ...
    eim.getMapInstance(324046000).spawnNpc(9390445, new java.awt.Point(1013,169));
}
