...
function action(mode, type, selection) {
    if (mode == -1) {
        ...
        if (a == -1) {
            ...
            cm.sendSimple("\r\n                     #e#r楓之谷商城#k#n#l\r\n"+eef+""+eef+""+eef+""+eef+""+eef+""+eef+""+eef+""+eef+""+eef+""+eef+""+eef+""+eef+""+eef+""+eef+""+eef+""+eef+""+eef+""+eef+""+eef+""+eef+""+eef+""+eef+""+eef+""+eef+""+eef+""+eef+""+eef+""+eef+""+eef+"\r\n#b#L0#雜貨商店#l#L1#公園幣商店#L2#BOSS幣商店#L3#滿月幣商店#l\r\n#L4#副手裝備#L5#真棒圖騰#L6#外星人幣商店#L7#低級武器店#l\r\n#L9#組隊點數店#L8#喇叭專賣#L10#結婚禮服#n#k#l\r\n\r\n#L36##r"+tz21+"【公告】#k樂豆點贊助 1 元 = 3000 樂豆點 首充雙倍"+tz21+"#l\r\n\r\n#r#L27#"+yun1+"樂豆點商店"+yun1+"#l\r\n#d#L14##g土豪商城  #L22#皮膚傷害 #L21#極品機器人#l\r\n#L23##r稀有椅子 #L32#玩具商店#l #L25#喇叭出售#l #L30#稀有點裝#l\r\n#L31##b雙倍道具 \r\n#L27##r"+yun1+"楓點商店"+yun1+"#l\r\n#L19##d職業副手#l #L26#楓點點裝 #L28#巨人藥水 #L20#楓點商城#l\r\n#L38#巨匠武器#l\r\n#L27##r"+yun1+"中介商店"+yun1+"#l\r\n#L12##b極品卷軸 #L29#時裝禮包  #L13#上乘裝備#l\r\n\r\n\r\n"+eef+""+eef+""+eef+""+eef+""+eef+""+eef+""+eef+""+eef+""+eef+""+eef+""+eef+""+eef+""+eef+""+eef+""+eef+""+eef+""+eef+""+eef+""+eef+""+eef+""+eef+""+eef+""+eef+""+eef+""+eef+""+eef+""+eef+""+eef+""+eef+"\r\n")
        } else if (a == 1) {
            if (selection == 0){
                cm.dispose();
            cm.openShop(61);
