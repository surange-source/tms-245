...
var name0 = "[系列]武陵組隊任務";
var name = Array(
        Array("[執行]武陵-仙人修煉場","仙人修煉場","NewEvent13",100,110),//執行顯示的名字、事件記錄、事件腳本名稱、帳號次數、怪物等級
        Array("[執行]武陵-通天林","通天林","NewEvent14",100,140),
        Array("[執行]武陵-熊之領域","熊之領域","NewEvent15",100,170),
        Array("[執行]武陵-藥草田","藥草田","NewEvent16",100,190),
        Array("[執行]武陵-海盜團巢穴","海盜團巢穴","NewEvent17",100,210)
);
