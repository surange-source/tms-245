...
//暴君系列轉蛋
Array(1072747, 100, 1, 1),//暴君阿爾泰靴
Array(1082547, 100, 1, 1),//暴君阿爾泰手套
Array(1102485, 100, 1, 1),//暴君阿爾泰披風
Array(1132178, 100, 1, 1),//暴君阿爾泰腰帶

//冒險之心繫列轉蛋
Array(4033755, 800, 1, 0), //心之項鏈鏈子
Array(2431560, 780, 1, 1), //楓之谷勇士之心(海盜)
Array(2431565, 750, 1, 1), //高級楓之谷勇士之心(海盜)
//意志肩飾腰帶轉蛋
    ...
    if (status == 0) {
        ...
        if (finalitem.length != 0) {
            ...
            if (cm.haveItem(5220040) && cm.canHold()) {
                if (notice == 1) {
                    cm.gainGachaponItem(itemId, quantity, "海盜轉蛋機");
                } else {
