...
var reward = new Array(// 禮包編號、道具id、數量
        ...
        Array(1, 2000005, 200), //超級藥水
        Array(1, 5062002, 10), // 高級神奇方塊
        Array(1, 5062000, 10), //神奇方塊
        Array(1, 4001714, 1), // 定居金一百萬
        Array(1, 2431738, 1),
        // 60
        Array(2, 2000005, 200), //超級藥水
        Array(2, 5062000, 20),
        Array(2, 5062002, 20), // 高級神奇方塊
        Array(2, 4001785, 1), // 定居金一百萬
        Array(2, 2431739, 1),
        // 120
        Array(3, 5062002, 30), // 高級神奇方塊
        Array(3, 5062000, 30), //神奇方塊
        Array(3, 5064000, 3), //防爆卷軸
        Array(3, 2340000, 1), //zhufu
        Array(3, 2049402, 1), //特殊潛能附加卷軸 100%
        Array(3, 4001785, 1), // 定居金五百萬
        Array(3, 2431739, 2), //楓點1000

        // 360
        Array(4, 5062002, 30), // 高級神奇方塊
        Array(4, 5062009, 15), //超級神奇方塊
        Array(4, 5064000, 5), //防爆卷軸
        Array(4, 2340000, 1), //zhufu
        Array(4, 2049750, 1), // 特殊潛能附加卷軸 80%
        Array(4, 4001785, 6), // 定居金五百萬
        Array(4, 2431739, 2), //楓點1000

        // 720
        Array(5, 5062010, 10), // 終極神奇方塊
        Array(5, 5062009, 20), //超級神奇方塊
        Array(5, 5062500, 15), //大師附加神奇方塊
        Array(5, 5064000, 5), //防爆卷軸
        Array(5, 2340000, 2), //zhufu
        Array(5, 2049750, 1), // 特殊潛能附加卷軸 80%
        Array(5, 2028175, 2), // 宿命正義卷軸箱
        Array(5, 4001785, 10), // 定居金五百萬
        Array(5, 2431739, 2), //楓點1000

        // 1020
        Array(6, 5062010, 30), // 終極神奇方塊
        Array(6, 5062009, 15), //超級神奇方塊
        Array(6, 5062500, 30), //大師附加神奇方塊
        Array(6, 5064000, 5), //防爆卷軸
        Array(6, 2340000, 5), //zhufu
        Array(6, 2049402, 2), //特殊潛能附加卷軸 100%
        Array(6, 2028175, 4), // 宿命正義卷軸箱
        Array(6, 4001715, 1), // 定居金一億
        Array(6, 4000463, 1), // 黃金楓葉
        Array(6, 2431739, 5)
        );
...
function action(mode, type, selection) {
    ...
    if (status == 0) {
        ...
        cm.worldMessage("『在線時間獎勵』" + " : " + "玩家 " + cm.getChar().getName() + " 領取了在線 " + condition[sel - 1] + " 分鐘獎勵。");
        /*if (sel == 4) {
