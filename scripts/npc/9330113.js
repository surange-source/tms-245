...
//暴君系列轉蛋
Array(1072744, 50, 1, 1),//暴君赫爾梅斯靴
Array(1082544, 50, 1, 1),//暴君赫爾梅斯手套
Array(1102482, 50, 1, 1),//暴君赫爾梅斯披風
Array(1132175, 50, 1, 1),//暴君赫爾梅斯腰帶

//冒險之心繫列轉蛋
Array(4033755, 800, 1, 0), //心之項鏈鏈子
Array(2431557, 780, 1, 1), //楓之谷勇士之心(法師)
Array(2431562, 750, 1, 1), //高級楓之谷勇士之心(法師)
//意志肩飾腰帶轉蛋
    ...
    if (status == 0) {
        ...
        if (finalitem.length != 0) {
            ...
            if (cm.haveItem(5220040) && cm.canHold()) {
                if (notice == 1) {
                    cm.gainGachaponItem(itemId, quantity, "法師轉蛋機");
                } else {
