...
function action(mode, type, selection) {
    ...
    if (status == 0) {
            var selStr = "        #e#d"+axx+"請選擇您要使用的轉盤"+axx+"#n#k\r\n";
        selStr +="#e#d#L0#"+zs1+"椅子樂豆點抽獎#l"+"#e#d#L1#"+zs1+"卷軸樂豆點抽獎#l"+"#e#d#L2#"+zs1+"裝備樂豆點抽獎#l#n\r\n\r\n";
               // selStr +="#e#r#L3#"+zs1+"椅子餘額抽獎#l"+"#e#r#L4#"+zs1+"卷軸餘額抽獎#l"+"#e#r#L5#"+zs1+"裝備餘額抽獎#l#n\r\n\r\n";
