...
function action(mode, type, selection) {
    if (mode == -1) {
        ...
        if (a == -1) {
            ...
            if (selection == 1) {
                cm.sendOk("#b升級錯誤:#k\r\n#i1112446##t1112446#通過樂豆點商城或任務等其它渠道獲得");
                cm.dispose();
            } else if (selection == 51) {
                cm.sendOk("#b老公老婆戒指升級說明:#k\r\n1.愛心寶石可以通過抽獎、VIP每日福利、活動副本等渠道獲得\r\n2.每升1個等級老公老婆戒指需要愛心寶石x10\r\n3.老公老婆戒指LV30的時候每升1個等級需要愛心寶石x200\r\n4.老公老婆戒指LV50的時候最高特殊屬性值為魔物攻擊力x50");
                cm.dispose();
            } else if (selection == 2) {
