...
var maxPartySize = 6;
var XZ;
var name0 = "[系列]玩具城組隊任務";
var name = Array(
        Array("[執行]玩具城-玩具工廠","玩具工廠","NewEvent26",100,200),
        Array("[執行]玩具城-時間塔內部","時間塔內部","NewEvent27",100,230),//執行顯示的名字、事件記錄、事件腳本名稱、帳號次數、怪物等級
        Array("[執行]玩具城-時間塔下層-#r（暴力熊）#b","時間塔下層","NewEvent28",100,190),
        Array("[執行]玩具城-時間塔最下層-#r（心疤獅王）#k","時間塔最下層","NewEvent29",100,170)
);
