...
function action(mode, type, selection) {
    if (mode == -1) {
        ...
        if (a == -1) {
            ...
            if (cm.getBossLog('HOTTIME隱藏的箱子') >= 1) {
            ...
            var text = "今天的獎品都變成了可疑的箱子，並且被打亂了。\r\n咦，到底是哪個呢？\r\n\r\n#b"
            for (var i = 0; i < luckyItem.length; i++) {
            ...
            var n = selection + 1
            var text = "我剛才選擇的是第" + n + "個道具.現在秘密箱子裡面的道具跑出來了:\r\n - 點擊下一步領取物品。\r\n\r\n#b"
