...
function action(mode, type, selection) {
    ...
    if (status == 0) {
        ...
        cm.sendDirectionEffectPlay("Effect/Direction6.img/effect/tuto/balloonMsg2/1");
        cm.setDelay(2000);
        ...
        cm.sendDirectionEffectPlay("Effect/Direction6.img/effect/tuto/balloonMsg1/16");
        cm.sendDirectionEffectPlay("Skill/3112.img/skill/31121006/effect");
        cm.showMapEffect("demonSlayer/31121006");
        cm.sendDirectionEffectPlay("Effect/Direction6.img/DemonTutorial/Scene3");
        cm.sendDirectionEffectPlay("Effect/Direction6.img/effect/tuto/balloonMsg1/17");
        cm.showMapEffect("demonSlayer/31121006h");
        cm.removeNpc(2159340);
        cm.removeNpc(2159341);
        cm.setInGameCurNodeEventEnd(true);
        cm.setForcedInput(0);
        cm.sendDirectionEffectPlay("Effect/Direction6.img/effect/tuto/balloonMsg0/13");
        ...
        cm.setForcedInput(2);
        cm.setDelay(1000);
        cm.sendDirectionEffectPlay("Effect/Direction6.img/effect/tuto/balloonMsg1/12");
        ...
        cm.setForcedAction(0, 373);
        if (cm.getPlayer().getGender() == 0) {
            cm.sendDirectionEffectPlay("Effect/Direction6.img/effect/tuto/fallMale");
        } else {
            cm.sendDirectionEffectPlay("Effect/Direction6.img/effect/tuto/fallFemale");
        }
        cm.sendDirectionEffectPlay("Effect/Direction6.img/effect/tuto/balloonMsg1/13");
        cm.warp(931050030,0);
        cm.dispose();
    }
}
