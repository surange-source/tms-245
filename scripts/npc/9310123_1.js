...
function action(mode, type, selection) {
    ...
    if (status == 0) {
        ...
        if (cm.getPlayer().getClient().getChannel() == 1) {
            if (cm.getPlayer().getMapId() == 703020100) { //傳送
                cm.sendSimple("#e#v3991051##v3991051##v3991051##v3991051#<Boss - 凡雷恩>#v3991050##v3991050##v3991050##v3991050##n\r\n你現在確定放棄任務,從這裡出去?\r\n#L2##b是的,現在就出去#l");


            } else {
                var pqtry = maxenter - cm.getPQLog(PQ);
                var rwpz = "";
                rwpz = "經驗指數：#v4140301##v4140301##v4140301##v4140301##v4140301#\r\n";
                rwpz += "#e推薦等級：180 - 250";
