...
var maxPartySize = 6;
var XZ;
var name0 = "[系列]弓箭手村組隊任務";
var name = Array(
        Array("[執行]弓箭手村-小蘑菇園","小蘑菇園","NewEvent9",100,90),//執行顯示的名字、事件記錄、事件腳本名稱、帳號次數、怪物等級
        Array("[執行]弓箭手村-石頭人領地","石頭人領地","NewEvent10",100,100),
        Array("[執行]弓箭手村-金色海岸","金色海岸","NewEvent11",100,170),
        Array("[執行]弓箭手村-沉睡樹林深處","沉睡樹林深處","NewEvent12",100,200)
);
