...
function action(mode, type, selection) {
    ...
    if (cm.getMapId() == 180000001) {
        ...
        selStr += "#r #L0#"+bzd+"在線福利"+bzd1+"#l #L1#"+bzd+"每日簽到"+bzd1+"#l #L2#"+bzd+"每日道具"+bzd1+"#l#k\r\n";
        selStr += "#r #L3#"+bzd+"等級獎勵"+bzd1+"#l #L4#"+bzd+"每日門票"+bzd1+"#l #L5#"+bzd+"儲值獎勵"+bzd1+"#l#k\r\n";
        ...
        case 2: // 每日道具
            if (cm.getPlayerStat("LVL") < 100) {
                ...
                if (cm.getEventCount("每日福利10") == 0  && cm.getOnlineTime()>60) {
                    ...
                    cm.sendOk("#r - 每日福利 >> \r\n#d每日福利領取成功#k\r\n獲得#v5062000# x 10  #v5062002# x 10 #v4310143# x 10  #v4310088# x 10  #v4310057# x 10  楓點10000點。");
                } else {
                    cm.sendOk("#r - 每日福利 >> #k\r\n\r\n對不起，一天只能福利一次。\r\n或您要在線60分鐘以上時才能領取！");
                }
            }
        ...
        case 6: //  排位獎勵
            cm.dispose();
            cm.openNpc(9000300, "meiridibao");
            break;
        case 7: //  每日送點
            cm.dispose();
            cm.openNpc(9000300, "hqye1")
            break;
        case 8: //  楓幣換點
            cm.dispose();
            cm.openNpc(9000300, "qiandao1")
            break;
        case 10: //  紋章
            cm.dispose();
