        ...
        if (status == 0) {
            ...
            if(typed==1){
                if (cm.haveItem(4000000,200) && cm.getPQLog("新手收集任務") <= 3) {
                    ...
                    cm.setPQLog("新手收集任務");
                    cm.sendOk("#b成功獲得了 #r積分#b 10 和 樂豆點 #r1000#b 獎勵。");
                    cm.worldSpouseMessage(0x01, "『新手任務』 : "+ cm.getChar().getName() +" 完成新手任務，獲得了豐富獎勵。");
                    cm.dispose();;
                } else {
                    cm.sendOk("您的物品不夠或者背包空間不足.或者您今天已經完成了3次。");
                    cm.dispose();
                }
            } else if (typed==2){
                if (cm.haveItem(4000001,200) && cm.getSpace(5) >= 1 && cm.getPQLog("新手收集任務") <= 3) {
                    ...
                    cm.gainPlayerPoints(10);
                    cm.setPQLog("新手收集任務");
                    cm.sendOk("#b成功獲得了30個超級方塊 和 #r積分#b  #r10#b 獎勵。");
                    cm.worldSpouseMessage(0x01, "『新手任務』 : "+ cm.getChar().getName() +" 完成新手任務，獲得了豐富獎勵。");
                    cm.dispose();;
                } else {
                    cm.sendOk("您的物品不夠或者背包空間不足.或者您今天已經完成了3次。");
                ...
                if (cm.haveItem(4000016,200) && cm.getSpace(5) >= 1 && cm.getPQLog("新手收集任務") <= 3) {
                    ...
                    cm.gainPlayerPoints(10);
                    cm.setPQLog("新手收集任務");
                    cm.sendOk("#b成功獲得了30個終極方塊 和 #r積分#b  #r10#b 獎勵。");
                    cm.worldSpouseMessage(0x01, "『新手任務』 : "+ cm.getChar().getName() +" 完成新手任務，獲得了豐富獎勵。");
                    cm.dispose();;
                } else {
                    cm.sendOk("您的物品不夠或者背包空間不足.或者您今天已經完成了3次。");
                ...
                if (cm.haveItem(4000004,200) && cm.getSpace(2) >= 3 && cm.getPQLog("新手收集任務") <= 3) {
                    ...
                    cm.gainItem(2431762, 3);
                    cm.gainPlayerPoints(10);
                    cm.setPQLog("新手收集任務");
                    cm.sendOk("#b成功獲得了3個黃金鵝蛋 和 #r積分#b  #r10#b 獎勵。");
                    cm.worldSpouseMessage(0x01, "『新手任務』 : "+ cm.getChar().getName() +" 完成新手任務，獲得了豐富獎勵。");
                    cm.dispose();;
                } else {
                    cm.sendOk("您的物品不夠或者背包空間不足.或者您今天已經完成了3次。");
                ...
                if (cm.haveItem(4000020,200) && cm.haveItem(4000051,200) && cm.getPQLog("新手收集任務") <= 3) {
                    ...
                    cm.gainPlayerPoints(10);
                    cm.setPQLog("新手收集任務");
                    cm.sendOk("#b成功獲得了#z2430683# 和 #r積分#b  #r10#b 獎勵。");
                    cm.worldSpouseMessage(0x01, "『新手任務』 : "+ cm.getChar().getName() +" 完成新手任務，獲得了豐富獎勵。");
                    cm.dispose();;
                } else {
                    cm.sendOk("您的物品不夠或者背包空間不足.或者您今天已經完成了3次。");
                ...
                if (cm.haveItem(4000448,200) && cm.haveItem(4000453,200) && cm.haveItem(4000458,200) && cm.haveItem(4000443,200) && cm.getPQLog("新手收集任務") <= 3) {
                    ...
                    cm.gainPlayerPoints(10);
                    cm.setPQLog("新手收集任務");
                    cm.sendOk("#b成功獲得了#z5062024# 和 #r積分#b  #r10#b 獎勵。");
                    cm.worldSpouseMessage(0x01, "『新手任務』 : "+ cm.getChar().getName() +" 完成新手任務，獲得了豐富獎勵。");
                    cm.dispose();;
                } else {
                    cm.sendOk("您的物品不夠或者背包空間不足.或者您今天已經完成了3次。");
