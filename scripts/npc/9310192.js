...
function action(mode, type, selection) {
    if (mode == -1) {
        ...
        if (status == -1) {
            ...
            text = "\t\t\t\t#e日常任務 - 每日任務30環#n\r\n\r\n";
            text += "您今日可領取次數：#r" + (maxtimes - accepttimes) + "#k 次\r\n";
            text += "完成每環任務會獲得如下獎勵：\r\n";
            text += "#r700點楓點、大量遊戲經驗、150個星星、700樂豆點#k\r\n";
            text += "每#r13、26#k環為#b雙倍獎勵#k以及#v4032766#*10，以及可升級神秘徽章的材料#v1712000#,並有幾率獲得#b#r#z2430781##k一個！\r\n#k";
            ...
            if (cm.getPlayer().getLevel() < 59) {
                ...
                if (accepttimes <= maxtimes) { // 判斷是否超過完成次數
                    ...
                    text += "\t\t#e當前第#r" + Math.max(1, accepttimes) + "#k環  收集 #r#z" + hitemid + "##g " + "40" + "#k個#n\r\n\r\n\r\n";
