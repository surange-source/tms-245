...
var status = -1;
var itemList = Array(
Array(1002846, 114000), //華爾茲絲帶貝雷帽
Array(1050152, 99000), //水兵服(男)
Array(1051180, 99000), //水兵服(女)
Array(1042104, 114000), //小綠葉T恤
Array(1042105, 114000), //小紅葉T恤
Array(1002845, 114000), //粉紅兔耳帽
Array(1052224, 99000), //草莓baby裝
Array(1702228, 114000), //可可香蕉
Array(1002721, 114000), //狸毛護耳
Array(1002568, 158400), //手工編織髮夾
Array(1702155, 99000), //絢麗彩虹
Array(1042142, 99000), //彩虹條背心
Array(1062093, 99000), //嫩綠休閒短褲
Array(1112904, 99000), //彩虹星環繞戒指
Array(1041142, 99000), //巨星蛋糕吊帶
Array(1061148, 99000), //巨星粉色短裙
Array(1702182, 99000), //洛麗波板糖
Array(1002888, 114000), //絲帶髮箍(紅色)
Array(1002890, 114000), //絲帶髮箍(藍色)
Array(1052200, 99000), //羅麗粉色娃娃套服
Array(1702208, 99000), //搞怪鱷魚
Array(1002863, 99000), //小熊熊可愛帽
Array(1052061, 66500), //巴西足球服No.9
Array(1052059, 66500), //法國足球服No.14
Array(1003207, 79200), //胡蘿蔔兔爆炸頭
Array(1702285, 74000), //藍色蝴蝶結手提包
...
Array(1702261, 99000), //櫻花棒
Array(1702091, 79200), //網球拍
Array(1702168, 99000), //閃亮聖誕樹
Array(1003051, 79200), //小狐狸
Array(1003048, 79200), //聖誕裝飾帽
Array(1002995, 100000), //皇家海軍帽
Array(1003012, 79200), //嫦娥髮式
Array(1002876, 99000), //聖誕紅髮夾
Array(1002839, 79200), //南瓜棒球帽
Array(1001048, 79200), //鬼娃娃帽
Array(1102225, 99000), //嫦娥披風
Array(1102217, 79200), //九尾披風
Array(1102157, 79200), //傀儡枷鎖
Array(1051131, 99000), //聖誕女孩子服
Array(1112916, 114000), //寂寞單身戒指
Array(1012179, 79200), //鹿鼻子
Array(1051152, 114000), //玫瑰紅晚宴裙
Array(1112118, 114000), //可樂名片戒指
Array(1112119, 114000), //可樂(Red) 名片戒指
Array(1112120, 114000), //可樂(White) 名片戒指
Array(1112228, 114000), //可樂聊天戒指
Array(1112229, 114000), //可樂(Red)聊天戒指
Array(1112230, 114000),  //可樂(White)聊天戒指
...
function action(mode, type, selection) {
    ...
    if (status == 0) {
        var selStr = "#fUI/UIWindow2.img/Quest/quest_info/summary_icon/summary#\r\n#fUI/UIWindow2.img/QuestAlarm/BtQ/normal/0#親愛的#r#h ##k您好，請選擇您希望刪除的道具：";
        ...
        if (item != null) {
            selectedItem = item[0];
            selectedCost = item[1];
            cm.sendYesNo("您是否刪除#i" + selectedItem + ":# #b#t" + selectedItem + "##k 需要 #r1000#k 樂豆點？");
        } else {
            cm.sendOk("出現錯誤...");
            cm.dispose();
        }
        ...
        cm.gainItem(selectedItem, -1)
                cm.gainNX( - 1000);
                cm.sendOk("恭喜您成功刪除#i" + selectedItem + ":# #b#t" + selectedItem + "##k。");
            } else {
                cm.sendOk("刪除失敗，請您確認在背包所有欄目窗口中是否有#i"+selectedItem+":# 該道具!。");
            }
        } else {
            cm.sendOk("您沒有那麼多樂豆點。\r\n\r\n刪除#i" + selectedItem + ":# #b#t" + selectedItem + "##k 需要 #r1000#k 樂豆點。");
        }
        cm.dispose();
    }
}
