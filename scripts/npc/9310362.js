...
var List = Array(
        ...
        Array(wi1 + "[一鍵轉職]", 9900002, "changeJob"),
        Array(wi1 + "[萬能傳送]", 9310362, "chuansong"),
        Array(wi2 + "#r[儲值福利]", 9310362, "chongzhijiangli"),
        Array(wi2 + "[在線獎勵]", 9310362, "zaixian"),
        Array(wi2 + "[每日必備]", 9310561, null),
        Array(wi3 + "#d#e[等級獎勵]", 9310362, "dengji1001"),
        Array(wi3 + "[管理中心]", 9000030, null),
        Array(wi3 + "[重置BOSS]", 9310362, "BOSScz"),
        Array(wi4 + "#g[刪除道具]", 9310362, "Delete"),
        Array(wi4 + "[美容美發]", 9310362, "meir"),
        Array(wi4 + "[所有商店]\r\n", 9310362, "Allshop")
        )
var text;
