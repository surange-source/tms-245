...
var axx = "#fEffect/CharacterEff/1051294/0/0#";  //愛心
var hh1= "#fEffect/ItemEff/3012021/1/9#";//彩虹
var hh7= "#fEffect/ItemEff/3994441/8#";//小精靈
var hh8= "#fEffect/CharacterEff/1050334/1/2#";//
var a = 0;
function start() {
    status = -1;
    action(1, 0, 0);
...
function action(mode, type, selection) {
    ...
    if (status == 0) {
            var selStr = "#e#d"+hh1+"\r\n"+"         "+"請選擇您要使用的#g轉盤#k"+hh7+"#n#k\r\n";
        selStr +="#b#L0#"+hh8+"樂豆點椅子#l"+"   "+"#b#L1#"+hh8+"樂豆點卷軸#l"+"   "+"#b#L2#"+hh8+"樂豆點裝備#l#n\r\n";
                selStr +="#r#L3#"+hh8+"餘額椅子#l"+"   "+"#r#L4#"+hh8+"餘額卷軸#l"+"   "+"#r#L5#"+hh8+"餘額裝備#l#n\r\n";
        cm.sendSimple(selStr);
    } else if (status == 1) {
        switch (selection) {
        case 0:
            cm.dispose();
            cm.openNpc(1500032,"NXYZ");
            break;
        case 1:
            cm.dispose();
        ...
        case 2:
            cm.dispose();
            cm.openNpc(1500032, "NXZB");
            break;
       case 3:
            cm.dispose();
            cm.openNpc(1500032, "HyPayYZ");
            break;
       case 4:
            cm.dispose();
            cm.openNpc(1500032, "HyPayJZ");
            break;
       case 5:
            cm.dispose();
            cm.openNpc(1500032, "HyPayZB");
            break;
        }
    }
}