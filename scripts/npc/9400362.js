...
function action(mode, type, selection) {
    ...
    if (mode == 1) {
        ...
        if (status == 0) {
            var selStr = "#d這裡是糖糖楓之谷賭博中心，請選擇你需要的：#n#k\r\n";
        selStr +="#e#L0#"+zs1+"使用#g樂豆點#k"+"賭博#l#\r";
                selStr +="#e#L1#"+zs1+"使用#b楓點#k"+"賭博#l#n\r\n";
        selStr +="#e#L2#"+zs1+"使用#r餘額#k"+"賭博#l#\r";
                selStr +="#e#L3#"+zs1+"使用#d楓幣#k"+"賭博#l#n\r\n";
;
        ...
        case 0:
            cm.dispose();
            cm.openNpc(1500032,"gamble1");
            break;
        case 1:
            cm.dispose();
            cm.openNpc(1500032,"gamble2");
            break;
        case 2:
            cm.dispose();
            cm.openNpc(1500032,"gamble3");
            break;
        case 3:
            cm.dispose();
            cm.openNpc(1500032,"gamble4");
            break;
