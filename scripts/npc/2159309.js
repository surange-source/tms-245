...
function action(mode, type, selection) {
    ...
    if (status == 0) {
        ...
        cm.sendDirectionEffectPlay("Effect/Direction6.img/effect/tuto/balloonMsg1/14");
        cm.setForcedAction(0, 325);
        cm.showMapEffect("demonSlayer/31111003");
        cm.sendDirectionEffectPlay("Skill/3111.img/skill/31111003/effect");
        cm.setDelay(1000);
        ...
        cm.sendDirectionEffectPlay("Effect/Direction6.img/effect/tuto/balloonMsg1/15");
        cm.setForcedAction(0, 365);
        cm.showMapEffect("demonSlayer/31121001");
        cm.sendDirectionEffectPlay("Skill/3112.img/skill/31121001/effect");
        cm.setDelay(1000);
