...
function action(mode, type, selection) {
    ...
    if (status == 0) {
        ...
        cm.sendDirectionEffectPlay("Effect/Direction6.img/effect/tuto/balloonMsg0/10");
        ...
        cm.sendDirectionEffectPlay("Effect/Direction6.img/effect/tuto/balloonMsg1/18");
        ...
        cm.sendDirectionEffectPlay("Effect/Direction6.img/effect/tuto/balloonMsg1/3");
        ...
        cm.sendDirectionEffectPlay("Effect/Direction6.img/effect/tuto/balloonMsg0/11");
