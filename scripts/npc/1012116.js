...
var List = Array(
        Array(sz1 + " #w回到市場", 2, 1),//名稱、NPC代碼、模式
        Array(sz2 + " 快速轉職", 9310362, "changeJob"),
        Array(sz3 + " 萬能傳送", 9310362, "worldwarp"),
        Array(sz4 + " 儲值中心", 9310362, "chongzhijiangli"),
        Array(sz5 + " 在線獎勵", 9310362, "zaixianshijian5"),
        Array(sz6 + " 每日福利", 9310362, "mrfl"),
        Array(sz7 + " BOSS傳送", 9310362, "BOSSwarp"),
        Array(sz8 + " 副本傳送", 9310362, "zuduirenwu"),
...
function action(mode, type, selection) {
    if (mode == -1) {
        ...
        if (a == -1) {
            ...
            //text +="\r\n";
            text +="#k        Ps：更多功能請到市場[賀客運營員]\r\n";
            text +="            常用指令#r@npc#k，#r@解卡#k，#r@卡圖#k，#r@幫助#k ";
            text +="  \r\n";
            cm.sendSimple(text);
        } else if (a == 1) {
            if (selection == 0) {
