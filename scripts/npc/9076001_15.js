...
var maxPartySize = 6;
var XZ;
var name0 = "[系列]埃德爾斯坦組隊任務";
var name = Array(
        Array("[執行]埃德爾斯坦-路燈街","路燈街","NewEvent18",100,210),//執行顯示的名字、事件記錄、事件腳本名稱、帳號次數、怪物等級
        Array("[執行]埃德爾斯坦-陡峭的巖山","陡峭的巖山","NewEvent19",100,170),
        Array("[執行]埃德爾斯坦-櫓礦山的深處","櫓礦山的深處","NewEvent20",100,180),
        Array("[執行]埃德爾斯坦-礦山警備地區","礦山警備地區","NewEvent21",100,200)
);
