    ...
    if (status == 0) {
        ...
        if (cm.getPlayer().getCSPoints(1) >= selectedCost) {
            if (cm.canHold(selectedItem, selequantity)) {
                ...
                cm.worldMessage("『機器人商城』 " + cm.getPlayer().getName() + " 玩家在機器人商城購買道具： " + cm.getItemName(selectedItem) + " x " + selequantity);
       ...
       if (cm.canHold(selectedItem, selequantity)) {
            ...
            cm.sendOk("您沒有那麼多楓點。\r\n\r\n購買#i" + selectedItem + ":# #b#t" + selectedItem + "##k x (" + selequantity + ") 需要 #r" + selectedCost + "#k 楓點。");
        }
        status = -1;
    }
}