...
//暴君系列轉蛋
Array(1072745, 100, 1, 1),//暴君凱倫靴
Array(1082545, 100, 1, 1),//暴君凱倫手套
Array(1102483, 100, 1, 1),//暴君凱倫披風
Array(1132176, 100, 1, 1),//暴君凱倫腰帶

//冒險之心繫列轉蛋
Array(4033755, 800, 1, 0), //心之項鏈鏈子
Array(2431558, 780, 1, 1), //楓之谷勇士之心(弓箭手)
Array(2431563, 750, 1, 1), //高級楓之谷勇士之心(弓箭手)
//意志肩飾腰帶轉蛋
    ...
    if (status == 0) {
        ...
        if (finalitem.length != 0) {
            ...
            if (cm.haveItem(5220040) && cm.canHold()) {
                if (notice == 1) {
                    cm.gainGachaponItem(itemId, quantity, "弓箭手轉蛋機");
                } else {
