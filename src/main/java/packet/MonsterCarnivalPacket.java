...
public class MonsterCarnivalPacket {
    ...
    public static byte[] startMonsterCarnival(final MapleCharacter chr, final int enemyavailable, final int enemytotal) {
        ...
        mplew.writeShort(SendPacketOpcode.LP_MCarnivalEnter.getValue());
    ...
    public static byte[] playerDiedMessage(String name, int lostCP, int team) { //CPQ
        ...
        mplew.writeShort(SendPacketOpcode.LP_MCarnivalDeath.getValue());
    ...
    public static byte[] playerLeaveMessage(boolean leader, String name, int team) {
        ...
        mplew.writeShort(SendPacketOpcode.LP_MCarnivalMemberOut.getValue());
    ...
    public static byte[] CPUpdate(int curCP, int totalCP) {
        ...
        mplew.writeShort(SendPacketOpcode.LP_MCarnivalPersonalCP.getValue());
    ...
    public static byte[] showMCStats(int left, int right) {
        ...
        mplew.writeShort(SendPacketOpcode.LP_MCarnivalSpellCooltime.getValue());
        mplew.writeInt(left);
    ...
    public static byte[] playerSummoned(String name, int tab, int number) {
        ...
        mplew.writeShort(SendPacketOpcode.LP_MCarnivalResultSuccess.getValue());
        mplew.write(tab);
        mplew.write(number);
        mplew.writeMapleAsciiString(name);
    ...
    public static byte[] showMCResult(int mode) {
        ...
        mplew.writeShort(SendPacketOpcode.LP_MCarnivalGameResult.getValue());
        mplew.write(mode);
    ...
    public static byte[] showMCRanking(List<MapleCharacter> players) {
        ...
        mplew.writeShort(SendPacketOpcode.LP_MCarnivalUpdateRankInfo.getValue());
    ...
    public static byte[] CPQMessage(byte message) {
        MaplePacketLittleEndianWriter mplew = new MaplePacketLittleEndianWriter();
        mplew.writeShort(SendPacketOpcode.LP_MCarnivalResultFail.getValue());
