...
public class CheckCodeImageCreator {
    ...
    public static File createImage(String code) {
    ...
    public static void main(String argc[]) {
        ...
        System.out.println(String.format("獲取驗證碼[%s] 耗時 %d ms", code, System.currentTimeMillis() - startTime));
        startTime = System.currentTimeMillis();
        File image = createImage(code);
        System.out.println(String.format("創建圖片 耗時 %d ms", System.currentTimeMillis() - startTime));
        startTime = System.currentTimeMillis();
        image.renameTo(new File(code + ".jpg"));
        System.out.println(String.format("移動圖片 耗時 %d ms", System.currentTimeMillis() - startTime));
    }
}
