...
public class WorldAllianceService {
    ...
    private static final Logger log = LogManager.getLogger(WorldAllianceService.class);
     ...
     * 聯盟聊天
     */
    public void allianceChat(int guildId, String name, int chrId, String msg, Item item) {
        ...
        if (chrGuild != null) {
            ...
            if (alliance != null) {
                for (int i = 0; i < alliance.getNoGuilds(); i++) {
                    ...
                    if (guild != null) {
                        guild.allianceChat(name, chrId, msg, item);
                    }
                }
            }
        }
